...
from cengal.parallel_execution.coroutines.coro_scheduler import current_interface, cs_acoro, Interface
...
from cengal.parallel_execution.coroutines.integrations.qt.pyside6 import CSlot, modal, qt_exec_in_coro, CoroThreadWithWorker, coro_slot_explicit
...
class CustomSignalExample(QMainWindow):
    ...
    def show_dialog(self):
        return modal(QMessageBox.information, None, "Hit 100", "Click OK when you think you hit 100.")
    ...
    @coro_slot_explicit()
    def update_counter(i: Interface, self: 'CustomSignalExample'):
