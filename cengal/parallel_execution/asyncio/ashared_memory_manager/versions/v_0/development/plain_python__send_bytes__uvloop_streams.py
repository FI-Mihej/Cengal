...
async def send_data(writer):
    ...
    print(f'send_data Throughput: {(300000 * mt.iterations) / mt.time_spent:.2f} bytes per second')
    print()
...
async def receiver(reader, writer):
    try:
        ...
        print(f'receiver Throughput: {(300000 * mt.iterations) / mt.time_spent:.2f} bytes per second')
        print()
