...
def run_mysql_import(file_name, db_name, user_name, password):
    result_command = MYSQL_RUN_COMMAND.format(db_name=handle_spaces(db_name),
                                              user_name=handle_spaces(user_name),
                                              password=handle_spaces(password),
                                              sql_dump_name=handle_spaces(file_name),
                                              socket=handle_spaces(MYSQLD_SOCKET),
