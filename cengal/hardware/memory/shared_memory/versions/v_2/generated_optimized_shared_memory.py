...
class TComplex:
    def map_to_shared_memory(self, shared_memory: 'SharedMemory', obj: complex) -> Tuple[complex, Offset, Size]:
        offset, real_size = shared_memory.malloc(ObjectType.tcomplex, 8)
        created_items_offsets: List[Offset] = list()
        try:
...
class RWLock:
    ...
    def request_read_access(self) -> None:
        write_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 16, 1)
        full_memory_barrier()
    
    def request_write_access(self) -> None:
        write_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 0, 1)
        full_memory_barrier()
    ...
    def drop_request_for_read_access(self) -> None:
        write_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 16, 0)
        full_memory_barrier()
    
    def drop_request_for_write_access(self) -> None:
        write_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 0, 0)
        full_memory_barrier()
    ...
    def restore_request_for_read_access(self, value: int) -> None:
        write_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 16, value)
        full_memory_barrier()
    
    def restore_request_for_write_access(self, value: int) -> None:
        write_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 0, value)
        full_memory_barrier()
    ...
    def acquire_read_access(self) -> bool:
        ...
        write_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 24, 1)
        # full_memory_barrier()
    
        if self.check_write_in_charge():
            write_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 24, 0)
            full_memory_barrier()
            return False
    ...
    def restore_read_access(self, value: int) -> None:
        write_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 24, value)
        full_memory_barrier()
    ...
    def acquire_write_access(self) -> bool:
        ...
        write_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 8, 1)
        # full_memory_barrier()
    
        if self.check_in_charge():
            write_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 8, 0)
            full_memory_barrier()
            return False
    ...
    def restore_write_access(self, value: int) -> None:
        write_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 8, value)
        full_memory_barrier()
            
    def check_my_write_request(self) -> bool:
        full_memory_barrier()
        return read_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 0)
    
    def check_my_read_request(self) -> bool:
        full_memory_barrier()
        return read_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 16)
    
    def check_my_requests(self) -> bool:
        full_memory_barrier()
        return read_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 0) or read_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 16)
    
    def check_my_write_in_charge(self) -> bool:
        full_memory_barrier()
        return read_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 8)
    
    def check_my_read_in_charge(self) -> bool:
        full_memory_barrier()
        return read_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 24)
    
    def check_my_in_charge(self) -> bool:
        full_memory_barrier()
        return read_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 8) or read_uint64(self.base_address, self.offset__data + self.operator_id * 32 + 24)
    ...
    def check_write_requests(self) -> bool:
        ...
        for operator_id in range(self.max_operators_num):
            ...
            if read_uint64(self.base_address, self.offset__data + operator_id * 32 + 0):
                return True
    ...
    def check_read_requests(self) -> bool:
        ...
        for operator_id in range(self.max_operators_num):
            ...
            if read_uint64(self.base_address, self.offset__data + operator_id * 32 + 16):
                return True
    ...
    def check_requests(self) -> bool:
        ...
        for operator_id in range(self.max_operators_num):
            ...
            if read_uint64(self.base_address, self.offset__data + operator_id * 32 + 0) or read_uint64(self.base_address, self.offset__data + operator_id * 32 + 16):
                return True
    ...
    def check_write_in_charge(self) -> bool:
        ...
        for operator_id in range(self.max_operators_num):
            ...
            if read_uint64(self.base_address, self.offset__data + operator_id * 32 + 8):
                return True
    ...
    def check_read_in_charge(self) -> bool:
        ...
        for operator_id in range(self.max_operators_num):
            ...
            if read_uint64(self.base_address, self.offset__data + operator_id * 32 + 24):
                return True
    ...
    def check_in_charge(self) -> bool:
        ...
        for operator_id in range(self.max_operators_num):
            ...
            if read_uint64(self.base_address, self.offset__data + operator_id * 32 + 8) or read_uint64(self.base_address, self.offset__data + operator_id * 32 + 24):
                return True
...
class TRWLock:
    def map_to_shared_memory(self, shared_memory: 'SharedMemory', obj: RWLock) -> Tuple[Decimal, Offset, Size]:
        offset, real_size = shared_memory.malloc(ObjectType.trwlock, (1 + shared_memory._max_consumers_num) * 32, zero_mem=True)
...
class TStaticObjectWithSlots:
    def map_to_shared_memory(self, shared_memory: 'SharedMemory', obj: Any) -> Tuple[Any, Offset, Size]:
        offset, real_size = shared_memory.malloc(ObjectType.tstaticobjectwithslots, 32)
        created_items_offsets: List[Offset] = list()
        try:
            dumped_obj: bytes = pickle_dumps(obj)
            dumped_mapped_obj, dumped_obj_offset, dumped_obj_size = shared_memory.put_obj(dumped_obj)
...
# ======================================================================================================================
# === ExternalTypesCollection ==========================================================================================================


@dataclass
class ExternalTypesCollection:
    codec_by_type: Dict[ObjectType, TBase]
    obj_type_map: Dict[Type, ObjectType]
    obj_base_type_map: Dict[Type, ObjectType]
...
class SharedMemory:
    shared_memory_type: int = 1

    __slots__ = ['_shared_memory', '_shared_memory_type', '_initiated', '_codec_by_type', '_obj_type_map', 
                 '_obj_base_type_map', '_external_types_collections', '_consumer_id', '_max_consumers_num', '_wait_for_consumers_num', '_creator_destroy_timeout', 
                 '_offset_to_be_monitored', '_malloc_time', '_realloc_time', '_name', '_create', '_queue_type', '_zero_mem', 
                 '_last_message_offset', '_asleep_func', '_size', 'base_address', 'sys_values_offset', 'free_memory_search_start', 
                 'global_sys_array_len', 'global_sys_area_size', '_get_in_line_on_write', '_get_in_line_on_write__time_limit', 
                 '_get_in_line_on_write__periodic_sleep_time']
    ...
    def __init__(self, name: str, create: bool = False, size: Optional[int] = None, queue_type: QueueType = QueueType.fifo, zero_mem: bool = True, 
                 ...
                 external_types_collections: Optional[Union[ExternalTypesCollection, List[ExternalTypesCollection]]] = None):
        ...
        self._codec_by_type: Dict[ObjectType, TBase] = codec_by_type
        self._obj_type_map: Dict[Type, ObjectType] = obj_type_map
        self._obj_base_type_map: Dict[Type, ObjectType] = obj_base_type_map
        self._external_types_collections: Optional[List[ExternalTypesCollection]] = list() if external_types_collections is None else external_types_collections
        if isinstance(self._external_types_collections, ExternalTypesCollection):
            self._external_types_collections = [self._external_types_collections]
        
        for external_types_collection in self._external_types_collections:
            self._codec_by_type.update(external_types_collection.codec_by_type)
            self._obj_type_map.update(external_types_collection.obj_type_map)
            self._obj_base_type_map.update(external_types_collection.obj_base_type_map)
        ...
        if self._create:
            ...
            write_uint64(self.base_address, self.sys_values_offset + 0, self._shared_memory_type)
            write_uint64(self.base_address, self.sys_values_offset + 8, self._size)
            write_uint64(self.base_address, self.sys_values_offset + 16, arr_byte_size)
            write_uint64(self.base_address, self.sys_values_offset + 24, self._size - arr_byte_size)
            write_uint64(self.base_address, self.sys_values_offset + 32, self._size)
            write_uint64(self.base_address, self.sys_values_offset + 40, arr_byte_size)
            ...
            write_uint64(self.base_address, self.sys_values_offset + 104, 0)
            write_uint64(self.base_address, self.sys_values_offset + 112, 0)
            write_uint64(self.base_address, self.sys_values_offset + 120, 0)
            write_uint64(self.base_address, self.sys_values_offset + 128, 0)
            write_uint64(self.base_address, self.sys_values_offset + 136, self._max_consumers_num)
            # write_uint64(self.base_address, self.sys_values_offset + 8 * SysValuesOffsets.consumers_num, 0)
    ...
    def calc_sys_arr_length(self, size: Optional[int] = None):
        if self._max_consumers_num is None:
            ...
            additional_consumers_array_length: int = 6 * (self._max_consumers_num - 1)
        
        additional_consumers_array_size: int = 8 * additional_consumers_array_length

        sys_arr_length = 18 + additional_consumers_array_length
    ...
    def init_consumer(self, time_limit: Optional[RationalNumber] = None, periodic_sleep_time: Optional[RationalNumber] = 0.000000001) -> bool:
        ...
        self._max_consumers_num = read_uint64(self.base_address, self.sys_values_offset + 136)
        self.wait_creator_ready(time_limit, periodic_sleep_time)
        
        self.global_sys_area_size = read_uint64(self.base_address, self.sys_values_offset + 16)
        self._max_consumers_num = read_uint64(self.base_address, self.sys_values_offset + 136)
        
        if self._size is None:
            self._size = read_uint64(self.base_address, self.sys_values_offset + 8)
        ...
        self._init_post_mem()
        shared_memory_type: int = read_uint64(self.base_address, self.sys_values_offset + 0)
    ...
    def set_consumer_ready(self):
        if -1 == self._consumer_id:
            write_uint64(self.base_address, self.sys_values_offset + 112, 1)
            write_uint64(self.base_address, self.sys_values_offset + 120, os.getpid())
            write_uint64(self.base_address, self.sys_values_offset + 104, 1)
        else:
            self.set_additional_consumer_ready()
    
    def set_additional_consumer_ready(self):
        consumer_id: int = self._consumer_id
        write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 24, 1)
        write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 32, os.getpid())
        write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 16, 1)
    ...
    def set_additional_consumer_closed(self):
        ...
        consumer_id: int = self._consumer_id
        write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 16, 0)
        write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 24, 0)
        write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 32, 0)
    ...
    def get_consumer_ready(self, consumer_id: int):
        if -1 == consumer_id:
            return read_uint64(self.base_address, self.sys_values_offset + 104)
        else:
            return self.get_additional_consumer_ready(consumer_id)
    
    def get_additional_consumer_ready(self, consumer_id: int):
        return read_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 16)
    ...
    def wait_consumer_ready(self, time_limit: Optional[RationalNumber] = None, periodic_sleep_time: Optional[RationalNumber] = 0.000000001) -> bool:
        ...
        start_time = cpu_clock()
        full_memory_barrier()
        while not read_uint64(self.base_address, self.sys_values_offset + 104):
            if time_limit is not None:
                if (cpu_clock() - start_time) > time_limit:
                    return False
    ...
    def wait_consumer_closed(self, time_limit: Optional[RationalNumber] = None, periodic_sleep_time: Optional[RationalNumber] = 0.000000001) -> bool:
        ...
        start_time = cpu_clock()
        full_memory_barrier()
        while read_uint64(self.base_address, self.sys_values_offset + 104):
            if time_limit is not None:
                if (cpu_clock() - start_time) > time_limit:
                    return False
    ...
    def consumer_in_charge(self) -> bool:
        # return read_uint64(self.base_address, self.sys_values_offset + 72) if 1 >= self._max_consumers_num else self.any_consumer_in_charge()
    ...
    def any_consumer_in_charge(self) -> bool:
        if read_uint64(self.base_address, self.sys_values_offset + 72):
            return 1
        else:
            for consumer_id in range(self._max_consumers_num - 1):
                if read_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 0):
                    return 1
    ...
    def any_consumer_in_charge_except(self, except_consumer_id: int) -> bool:
        if (0 <= except_consumer_id) and read_uint64(self.base_address, self.sys_values_offset + 72):
            return 1
        else:
            for consumer_id in range(self._max_consumers_num - 1):
    ...
    def ready_consumers_num(self) -> bool:
        ready_num = 0
        if read_uint64(self.base_address, self.sys_values_offset + 104):
            ready_num += 1

        for consumer_id in range(self._max_consumers_num - 1):
            if read_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 16):
                ready_num += 1
    ...
    def read_max_consumers_num(self) -> int:
        # return self.get_data_start_offset()
        return read_uint64(self.base_address, self.sys_values_offset + 136)
    ...
    def set_current_consumer_executable_path(self) -> Optional[int]:
        ...
        with wait_my_turn(self):
            ...
            if -1 == self._consumer_id:
                write_uint64(self.base_address, self.sys_values_offset + 128, offset)
            else:
                write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * self._consumer_id + 40, offset)
    ...
    def try_register_new_consumer(self) -> Optional[int]:
        ...
        while attempt_index < 7:
            ...
            full_memory_barrier()
            try:
                if read_uint64(self.base_address, self.sys_values_offset + 104) or \
                    read_uint64(self.base_address, self.sys_values_offset + 112):
                    for consumer_id in range(self._max_consumers_num - 1):
                        if read_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 16) or \
                            read_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 24):
                            continue
                        else:
                            write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 24, 1)
                            write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 32, current_pid)
                            full_memory_barrier()
                            sub_attempt_index = 0
                            while sub_attempt_index < 3:
                                ...
                                if (not read_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 24)) or \
                                    (read_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 32) != current_pid):
                                    write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 24, 0)
                                    write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * consumer_id + 32, 0)
                                    full_memory_barrier()
                                    raise InternalConsumerRegisteringError
                    ...
                    write_uint64(self.base_address, self.sys_values_offset + 112, 1)
                    write_uint64(self.base_address, self.sys_values_offset + 120, current_pid)
                    full_memory_barrier()
                    sub_attempt_index = 0
                    while sub_attempt_index < 3:
                        self.random_wait_ms()
                        ...
                        if (not read_uint64(self.base_address, self.sys_values_offset + 112)) or \
                            (read_uint64(self.base_address, self.sys_values_offset + 120) != current_pid):
                            write_uint64(self.base_address, self.sys_values_offset + 112, 0)
                            write_uint64(self.base_address, self.sys_values_offset + 120, 0)
                            full_memory_barrier()
                            raise InternalConsumerRegisteringError
    ...
    def set_last_message_offset(self, offset: Offset):
        write_uint64(self.base_address, self.sys_values_offset + 56, offset)
    ...
    def get_data_size(self) -> Size:
        return read_uint64(self.base_address, self.sys_values_offset + 24)
    
    def get_data_end_offset(self) -> Offset:
        result = read_uint64(self.base_address, self.sys_values_offset + 32)
    ...
    def put_obj(self, obj: Any):
        ...
        codec = self._codec_by_type[obj_type]
    ...
    def get_in_line(self) -> bool:
        if self._create:
            ...
            if 0 > self._consumer_id:
                ...
                write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * self._consumer_id + 0, 0)
                write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * self._consumer_id + 8, 1)
                full_memory_barrier()
                if self.creator_in_charge() or self.consumer_in_charge_except(self._consumer_id):
                    return False
                else:
                    write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * self._consumer_id + 0, 1)
                    full_memory_barrier()
                    write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * self._consumer_id + 8, 0)
                    full_memory_barrier()
                    self.update_free_memory_search_start()
                    if self.creator_in_charge() or self.consumer_in_charge_except(self._consumer_id):
                        write_uint64(self.base_address, self.sys_values_offset + 144 + 48 * self._consumer_id + 0, 0)
    ...
    def _get_obj_type(self, obj: Any) -> ObjectType:
        obj_type = type(obj)
        if obj is None:
        ...
        elif obj_type in self._obj_type_map:
            obj_type_atom = self._obj_type_map[obj_type]
        ...
        #     obj_type_atom = ObjectType.tstaticobjectwithslots
            ...
            for base_type, obj_type_atom in self._obj_base_type_map.items():
                if issubclass(obj_type, base_type):
                    break
            else:
                if hasattr(obj, '__slots__') or ((not hasattr(obj, '__slots__')) and (not hasattr(obj, '__dict__'))):
                    obj_type_atom = ObjectType.tstaticobjectwithslots
                else:
                    # obj_type_atom = ObjectType.tgeneralobject
                    obj_type_atom = ObjectType.tstaticobject
