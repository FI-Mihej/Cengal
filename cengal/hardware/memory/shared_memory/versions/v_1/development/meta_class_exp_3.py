...
namespace = CustomType.__prepare__('MyClass', (MyClassOrig,), init_message='Hello, Dynamic MyClass!')
namespace.update({
    'x': 5,
    'y': 'hello',
...
pdi(namespace)
MyClass = CustomType('MyClass', (MyClassOrig,), namespace, init_message='Hello, Dynamic MyClass!')
