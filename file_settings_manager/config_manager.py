...
from help_tools import get_text_in_brackets
import copy
...
class ConfigManager:
    ...
    def get_property(self, file_name, property_name):
        result = None
        self.load(file_name)
    ...
    def set_property(self, file_name, property_name, data):
        '''
        :param file_name:
        :param property_name:
    ...
    def remove_property(self, file_name, property_name):
