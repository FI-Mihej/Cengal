...
sudo pip3 install urllib3  # already preinstalled in Ubuntu 14.04 x64
sudo pip3 install thrift
sudo pip3 install thriftpy
sudo pip3 install tornado
sudo pip3 install requests  # already preinstalled in Ubuntu 14.04 x64
sudo pip3 install simplejson
sudo pip3 install pyOpenSSL
sudo pip3 install pycurl  # already preinstalled in Ubuntu 14.04 x64
sudo pip3 install pycrypto
sudo pip3 install pyasn1  # already preinstalled in Ubuntu 14.04 x64
...
sudo pip3 install html5lib  # already preinstalled in Ubuntu 14.04 x64
...
sudo pip3 install cryptography  # already preinstalled in Ubuntu 14.04 x64
