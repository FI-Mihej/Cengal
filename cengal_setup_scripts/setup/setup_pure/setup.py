...
readme_file_path = os.path.normpath(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'README.md'))
...
setuptools.setup(
    ...
    py_modules=['cengal'],
    packages=setuptools.find_packages(where='cengal'),
    ...
    extras_require={
        ...
        'cengal__data_manipulation__serialization': [
            ...
            "msgspec; python_version < '3.13' and platform_python_implementation == 'CPython'",
        ],
