...
</span><span id="L-50"><a href="#L-50"><span class="linenos"> 50</span></a>    <span class="n">result</span> <span class="o">=</span> <span class="n">result</span><span class="o">.</span><span class="n">strip</span><span class="p">()</span>
...
</span><span id="L-69"><a href="#L-69"><span class="linenos"> 69</span></a><span class="k">if</span> <span class="s1">&#39;PyPy&#39;</span> <span class="o">==</span> <span class="n">PLATFORM_NAME</span><span class="p">:</span>
...
</span><span id="L-98"><a href="#L-98"><span class="linenos"> 98</span></a><span class="sd">    :return:</span>
...
</span><span id="L-127"><a href="#L-127"><span class="linenos">127</span></a><span class="sd">    :param byte_data:</span>
...
</span><span id="L-183"><a href="#L-183"><span class="linenos">183</span></a>    <span class="n">result</span> <span class="o">=</span> <span class="n">struct</span><span class="o">.</span><span class="n">unpack</span><span class="p">(</span><span class="s1">&#39;&lt;I&#39;</span><span class="p">,</span> <span class="n">bytes_data</span><span class="p">)[</span><span class="mi">0</span><span class="p">]</span>
...
</span><span id="L-211"><a href="#L-211"><span class="linenos">211</span></a><span class="sd">    :return: bytes(); len == 1</span>
...
</span><span id="L-238"><a href="#L-238"><span class="linenos">238</span></a>    <span class="n">result</span> <span class="o">=</span> <span class="nb">int</span><span class="o">.</span><span class="n">from_bytes</span><span class="p">(</span><span class="n">bin_dword</span><span class="p">,</span> <span class="n">byteorder</span><span class="o">=</span><span class="n">byteorder</span><span class="p">,</span> <span class="n">signed</span><span class="o">=</span><span class="n">signed</span><span class="p">)</span>
...
</span><span id="L-261"><a href="#L-261"><span class="linenos">261</span></a>    <span class="n">delimiter</span> <span class="o">=</span> <span class="n">none_or</span><span class="p">(</span><span class="n">delimiter</span><span class="p">,</span> <span class="s1">&#39; &#39;</span><span class="p">)</span>
...
</span><span id="bytes_to_short-122"><a href="#bytes_to_short-122"><span class="linenos">122</span></a>    <span class="k">return</span> <span class="n">result</span>
</span></pre></div>
...
</span><span id="float_to_bytes-152"><a href="#float_to_bytes-152"><span class="linenos">152</span></a>    <span class="n">result</span> <span class="o">=</span> <span class="n">struct</span><span class="o">.</span><span class="n">pack</span><span class="p">(</span><span class="s1">&#39;f&#39;</span><span class="p">,</span> <span class="n">float_data</span><span class="p">)</span>
...
</span><span id="ushort_to_bytes-192"><a href="#ushort_to_bytes-192"><span class="linenos">192</span></a><span class="sd">    :return: bytes(); len == 2</span>
...
</span><span id="ubyte_to_bytes-210"><a href="#ubyte_to_bytes-210"><span class="linenos">210</span></a><span class="sd">    For a 8 bit unsigned byte</span>
</span><span id="ubyte_to_bytes-211"><a href="#ubyte_to_bytes-211"><span class="linenos">211</span></a><span class="sd">    :param byte_data:</span>
</span><span id="ubyte_to_bytes-212"><a href="#ubyte_to_bytes-212"><span class="linenos">212</span></a><span class="sd">    :return: bytes(); len == 1</span>
</span><span id="ubyte_to_bytes-213"><a href="#ubyte_to_bytes-213"><span class="linenos">213</span></a><span class="sd">    &quot;&quot;&quot;</span>
</span><span id="ubyte_to_bytes-214"><a href="#ubyte_to_bytes-214"><span class="linenos">214</span></a>    <span class="n">result</span> <span class="o">=</span> <span class="n">struct</span><span class="o">.</span><span class="n">pack</span><span class="p">(</span><span class="s1">&#39;&lt;B&#39;</span><span class="p">,</span> <span class="n">byte_data</span><span class="p">)</span>
</span><span id="ubyte_to_bytes-215"><a href="#ubyte_to_bytes-215"><span class="linenos">215</span></a>    <span class="k">return</span> <span class="n">result</span>
</span></pre></div>
...
<div class="attr function">
    ...
    <a class="headerlink" href="#bytes_to_ubyte"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="bytes_to_ubyte-218"><a href="#bytes_to_ubyte-218"><span class="linenos">218</span></a><span class="k">def</span> <span class="nf">bytes_to_ubyte</span><span class="p">(</span><span class="n">bytes_data</span><span class="p">:</span> <span class="nb">bytes</span><span class="p">)</span><span class="o">-&gt;</span><span class="nb">int</span><span class="p">:</span>
</span><span id="bytes_to_ubyte-219"><a href="#bytes_to_ubyte-219"><span class="linenos">219</span></a><span class="w">    </span><span class="sd">&quot;&quot;&quot;</span>
</span><span id="bytes_to_ubyte-220"><a href="#bytes_to_ubyte-220"><span class="linenos">220</span></a><span class="sd">    For a 8 bit unsigned byte</span>
</span><span id="bytes_to_ubyte-221"><a href="#bytes_to_ubyte-221"><span class="linenos">221</span></a><span class="sd">    :param bytes_data:</span>
</span><span id="bytes_to_ubyte-222"><a href="#bytes_to_ubyte-222"><span class="linenos">222</span></a><span class="sd">    :return:</span>
</span><span id="bytes_to_ubyte-223"><a href="#bytes_to_ubyte-223"><span class="linenos">223</span></a><span class="sd">    &quot;&quot;&quot;</span>
</span><span id="bytes_to_ubyte-224"><a href="#bytes_to_ubyte-224"><span class="linenos">224</span></a>    <span class="n">result</span> <span class="o">=</span> <span class="n">struct</span><span class="o">.</span><span class="n">unpack</span><span class="p">(</span><span class="s1">&#39;&lt;B&#39;</span><span class="p">,</span> <span class="n">bytes_data</span><span class="p">)[</span><span class="mi">0</span><span class="p">]</span>
</span><span id="bytes_to_ubyte-225"><a href="#bytes_to_ubyte-225"><span class="linenos">225</span></a>    <span class="k">return</span> <span class="n">result</span>
</span></pre></div>
...
<div class="attr function">
    ...
    <a class="headerlink" href="#hex_dword_to_int"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="hex_dword_to_int-229"><a href="#hex_dword_to_int-229"><span class="linenos">229</span></a><span class="k">def</span> <span class="nf">hex_dword_to_int</span><span class="p">(</span><span class="n">dword</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">byteorder</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span> <span class="n">signed</span><span class="o">=</span><span class="kc">False</span><span class="p">)</span><span class="o">-&gt;</span><span class="nb">bytes</span><span class="p">:</span>
</span><span id="hex_dword_to_int-230"><a href="#hex_dword_to_int-230"><span class="linenos">230</span></a><span class="w">    </span><span class="sd">&quot;&quot;&quot;</span>
</span><span id="hex_dword_to_int-231"><a href="#hex_dword_to_int-231"><span class="linenos">231</span></a><span class="sd">    &quot;0x008A151D&quot; is big endian; so dword = &#39;008A151D&#39;, byteorder = &#39;big&#39;</span>
</span><span id="hex_dword_to_int-232"><a href="#hex_dword_to_int-232"><span class="linenos">232</span></a><span class="sd">    :param dword: str(); &#39;008A151D&#39;</span>
</span><span id="hex_dword_to_int-233"><a href="#hex_dword_to_int-233"><span class="linenos">233</span></a><span class="sd">    :param byteorder: str(); &#39;big&#39; / &#39;little&#39;</span>
</span><span id="hex_dword_to_int-234"><a href="#hex_dword_to_int-234"><span class="linenos">234</span></a><span class="sd">    :param signed: bool();</span>
</span><span id="hex_dword_to_int-235"><a href="#hex_dword_to_int-235"><span class="linenos">235</span></a><span class="sd">    :return: 9049373</span>
</span><span id="hex_dword_to_int-236"><a href="#hex_dword_to_int-236"><span class="linenos">236</span></a><span class="sd">    &quot;&quot;&quot;</span>
</span><span id="hex_dword_to_int-237"><a href="#hex_dword_to_int-237"><span class="linenos">237</span></a>    <span class="n">byteorder</span> <span class="o">=</span> <span class="n">byteorder</span> <span class="ow">or</span> <span class="s1">&#39;big&#39;</span>
</span><span id="hex_dword_to_int-238"><a href="#hex_dword_to_int-238"><span class="linenos">238</span></a>    <span class="n">bin_dword</span> <span class="o">=</span> <span class="n">binascii</span><span class="o">.</span><span class="n">unhexlify</span><span class="p">(</span><span class="n">dword</span><span class="p">)</span>
</span><span id="hex_dword_to_int-239"><a href="#hex_dword_to_int-239"><span class="linenos">239</span></a>    <span class="n">result</span> <span class="o">=</span> <span class="nb">int</span><span class="o">.</span><span class="n">from_bytes</span><span class="p">(</span><span class="n">bin_dword</span><span class="p">,</span> <span class="n">byteorder</span><span class="o">=</span><span class="n">byteorder</span><span class="p">,</span> <span class="n">signed</span><span class="o">=</span><span class="n">signed</span><span class="p">)</span>
</span><span id="hex_dword_to_int-240"><a href="#hex_dword_to_int-240"><span class="linenos">240</span></a>    <span class="k">return</span> <span class="n">result</span>
</span></pre></div>
...
<div class="attr function">
    ...
    <a class="headerlink" href="#int_to_hex_dword"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="int_to_hex_dword-243"><a href="#int_to_hex_dword-243"><span class="linenos">243</span></a><span class="k">def</span> <span class="nf">int_to_hex_dword</span><span class="p">(</span><span class="n">int_value</span><span class="p">,</span> <span class="n">byteorder</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span> <span class="n">signed</span><span class="o">=</span><span class="kc">False</span><span class="p">):</span>
</span><span id="int_to_hex_dword-244"><a href="#int_to_hex_dword-244"><span class="linenos">244</span></a>    <span class="n">byteorder</span> <span class="o">=</span> <span class="n">byteorder</span> <span class="ow">or</span> <span class="s1">&#39;big&#39;</span>
</span><span id="int_to_hex_dword-245"><a href="#int_to_hex_dword-245"><span class="linenos">245</span></a>    <span class="n">result</span> <span class="o">=</span> <span class="p">(</span><span class="n">binascii</span><span class="o">.</span><span class="n">hexlify</span><span class="p">(</span><span class="n">int_value</span><span class="o">.</span><span class="n">to_bytes</span><span class="p">(</span><span class="mi">4</span><span class="p">,</span> <span class="n">byteorder</span><span class="o">=</span><span class="n">byteorder</span><span class="p">,</span> <span class="n">signed</span><span class="o">=</span><span class="n">signed</span><span class="p">)))</span><span class="o">.</span><span class="n">decode</span><span class="p">()</span>
</span><span id="int_to_hex_dword-246"><a href="#int_to_hex_dword-246"><span class="linenos">246</span></a>    <span class="k">return</span> <span class="n">result</span>
</span></pre></div>
                ...
                <section id="str_to_base64str">
                            <input id="str_to_base64str-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
            
        <span class="def">def</span>
        <span class="name">str_to_base64str</span><span class="signature pdoc-code condensed">(<span class="param"><span class="n">string_data</span></span><span class="return-annotation">):</span></span>

                <label class="view-source-button" for="str_to_base64str-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#str_to_base64str"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="str_to_base64str-250"><a href="#str_to_base64str-250"><span class="linenos">250</span></a><span class="k">def</span> <span class="nf">str_to_base64str</span><span class="p">(</span><span class="n">string_data</span><span class="p">):</span>
</span><span id="str_to_base64str-251"><a href="#str_to_base64str-251"><span class="linenos">251</span></a>    <span class="n">result</span> <span class="o">=</span> <span class="n">base64</span><span class="o">.</span><span class="n">b64encode</span><span class="p">(</span><span class="nb">str</span><span class="p">(</span><span class="n">string_data</span><span class="p">)</span><span class="o">.</span><span class="n">encode</span><span class="p">())</span><span class="o">.</span><span class="n">decode</span><span class="p">()</span>
</span><span id="str_to_base64str-252"><a href="#str_to_base64str-252"><span class="linenos">252</span></a>    <span class="k">return</span> <span class="n">result</span>
</span></pre></div>
                ...
                <section id="base64str_to_str">
                            <input id="base64str_to_str-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
            
        <span class="def">def</span>
        <span class="name">base64str_to_str</span><span class="signature pdoc-code condensed">(<span class="param"><span class="n">base64string_data</span></span><span class="return-annotation">):</span></span>

                <label class="view-source-button" for="base64str_to_str-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#base64str_to_str"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="base64str_to_str-255"><a href="#base64str_to_str-255"><span class="linenos">255</span></a><span class="k">def</span> <span class="nf">base64str_to_str</span><span class="p">(</span><span class="n">base64string_data</span><span class="p">):</span>
</span><span id="base64str_to_str-256"><a href="#base64str_to_str-256"><span class="linenos">256</span></a>    <span class="n">result</span> <span class="o">=</span> <span class="n">base64</span><span class="o">.</span><span class="n">b64decode</span><span class="p">(</span><span class="nb">str</span><span class="p">(</span><span class="n">base64string_data</span><span class="p">)</span><span class="o">.</span><span class="n">encode</span><span class="p">())</span><span class="o">.</span><span class="n">decode</span><span class="p">()</span>
</span><span id="base64str_to_str-257"><a href="#base64str_to_str-257"><span class="linenos">257</span></a>    <span class="k">return</span> <span class="n">result</span>
</span></pre></div>
                ...
                <section id="split_solid_hex_string">
                            <input id="split_solid_hex_string-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
            
        <span class="def">def</span>
        <span class="name">split_solid_hex_string</span><span class="signature pdoc-code condensed">(<span class="param"><span class="n">hex_string</span>, </span><span class="param"><span class="n">delimiter</span><span class="o">=</span><span class="kc">None</span></span><span class="return-annotation">):</span></span>

                <label class="view-source-button" for="split_solid_hex_string-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#split_solid_hex_string"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="split_solid_hex_string-261"><a href="#split_solid_hex_string-261"><span class="linenos">261</span></a><span class="k">def</span> <span class="nf">split_solid_hex_string</span><span class="p">(</span><span class="n">hex_string</span><span class="p">,</span> <span class="n">delimiter</span><span class="o">=</span><span class="kc">None</span><span class="p">):</span>
</span><span id="split_solid_hex_string-262"><a href="#split_solid_hex_string-262"><span class="linenos">262</span></a>    <span class="n">delimiter</span> <span class="o">=</span> <span class="n">none_or</span><span class="p">(</span><span class="n">delimiter</span><span class="p">,</span> <span class="s1">&#39; &#39;</span><span class="p">)</span>
</span><span id="split_solid_hex_string-263"><a href="#split_solid_hex_string-263"><span class="linenos">263</span></a>    <span class="n">fake_start</span> <span class="o">=</span> <span class="s1">&#39;00&#39;</span>
</span><span id="split_solid_hex_string-264"><a href="#split_solid_hex_string-264"><span class="linenos">264</span></a>    <span class="n">fake_start_len</span> <span class="o">=</span> <span class="nb">len</span><span class="p">(</span><span class="n">fake_start</span><span class="p">)</span>
</span><span id="split_solid_hex_string-265"><a href="#split_solid_hex_string-265"><span class="linenos">265</span></a>    <span class="n">hex_string</span> <span class="o">=</span> <span class="n">fake_start</span> <span class="o">+</span> <span class="n">hex_string</span>
</span><span id="split_solid_hex_string-266"><a href="#split_solid_hex_string-266"><span class="linenos">266</span></a>    <span class="n">result</span> <span class="o">=</span> <span class="n">delimiter</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="nb">map</span><span class="p">(</span><span class="s1">&#39;&#39;</span><span class="o">.</span><span class="n">join</span><span class="p">,</span> <span class="nb">zip</span><span class="p">(</span><span class="o">*</span><span class="p">[</span><span class="nb">iter</span><span class="p">(</span><span class="n">hex_string</span><span class="p">)]</span><span class="o">*</span><span class="mi">2</span><span class="p">)))[</span><span class="n">fake_start_len</span><span class="p">:]</span>
</span><span id="split_solid_hex_string-267"><a href="#split_solid_hex_string-267"><span class="linenos">267</span></a>    <span class="n">result</span> <span class="o">=</span> <span class="n">result</span><span class="o">.</span><span class="n">strip</span><span class="p">()</span>
</span><span id="split_solid_hex_string-268"><a href="#split_solid_hex_string-268"><span class="linenos">268</span></a>    <span class="k">return</span> <span class="n">result</span>
</span></pre></div>
                ...
                <section id="get_slice_from_array">
                            <input id="get_slice_from_array-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
            
        <span class="def">def</span>
        <span class="name">get_slice_from_array</span><span class="signature pdoc-code condensed">(<span class="param"><span class="n">data</span>, </span><span class="param"><span class="n">offset</span>, </span><span class="param"><span class="n">size</span></span><span class="return-annotation">):</span></span>

                <label class="view-source-button" for="get_slice_from_array-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#get_slice_from_array"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="get_slice_from_array-271"><a href="#get_slice_from_array-271"><span class="linenos">271</span></a><span class="k">def</span> <span class="nf">get_slice_from_array</span><span class="p">(</span><span class="n">data</span><span class="p">,</span> <span class="n">offset</span><span class="p">,</span> <span class="n">size</span><span class="p">):</span>
</span><span id="get_slice_from_array-272"><a href="#get_slice_from_array-272"><span class="linenos">272</span></a>    <span class="n">result</span> <span class="o">=</span> <span class="n">data</span><span class="p">[</span><span class="n">offset</span><span class="p">:</span> <span class="n">offset</span> <span class="o">+</span> <span class="n">size</span><span class="p">]</span>
</span><span id="get_slice_from_array-273"><a href="#get_slice_from_array-273"><span class="linenos">273</span></a>    <span class="k">return</span> <span class="n">result</span>
</span></pre></div>
                ...
                <section id="inverse_mapping">
                            <input id="inverse_mapping-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
            
        <span class="def">def</span>
        <span class="name">inverse_mapping</span><span class="signature pdoc-code condensed">(<span class="param"><span class="n">f</span></span><span class="return-annotation">):</span></span>

                <label class="view-source-button" for="inverse_mapping-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#inverse_mapping"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="inverse_mapping-276"><a href="#inverse_mapping-276"><span class="linenos">276</span></a><span class="k">def</span> <span class="nf">inverse_mapping</span><span class="p">(</span><span class="n">f</span><span class="p">):</span>
</span><span id="inverse_mapping-277"><a href="#inverse_mapping-277"><span class="linenos">277</span></a>    <span class="k">return</span> <span class="n">f</span><span class="o">.</span><span class="vm">__class__</span><span class="p">(</span><span class="nb">map</span><span class="p">(</span><span class="nb">reversed</span><span class="p">,</span> <span class="n">f</span><span class="o">.</span><span class="n">items</span><span class="p">()))</span>
</span></pre></div>
...
<div class="attr function">
        ...
        <span class="name">hex_string__to__bytes</span><span class="signature pdoc-code condensed">(<span class="param"><span class="n">input_data</span><span class="p">:</span> <span class="nb">str</span>, </span><span class="param"><span class="n">delimiter</span><span class="p">:</span> <span class="nb">str</span> <span class="o">=</span> <span class="kc">None</span></span><span class="return-annotation">) -> <span class="nb">bytes</span>:</span></span>
                ...
                <label class="view-source-button" for="hex_string__to__bytes-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#hex_string__to__bytes"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="hex_string__to__bytes-61"><a href="#hex_string__to__bytes-61"><span class="linenos">61</span></a>    <span class="k">def</span> <span class="nf">hex_string__to__bytes</span><span class="p">(</span><span class="n">input_data</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">delimiter</span><span class="p">:</span> <span class="nb">str</span><span class="o">=</span><span class="kc">None</span><span class="p">)</span><span class="o">-&gt;</span><span class="nb">bytes</span><span class="p">:</span>
</span><span id="hex_string__to__bytes-62"><a href="#hex_string__to__bytes-62"><span class="linenos">62</span></a>        <span class="n">delimiter</span> <span class="o">=</span> <span class="n">none_or</span><span class="p">(</span><span class="n">delimiter</span><span class="p">,</span> <span class="s1">&#39; &#39;</span><span class="p">)</span>
</span><span id="hex_string__to__bytes-63"><a href="#hex_string__to__bytes-63"><span class="linenos">63</span></a>        <span class="n">result</span> <span class="o">=</span> <span class="sa">b</span><span class="s1">&#39;&#39;</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">binascii</span><span class="o">.</span><span class="n">unhexlify</span><span class="p">(</span><span class="n">b</span><span class="p">)</span> <span class="k">for</span> <span class="n">b</span> <span class="ow">in</span> <span class="n">input_data</span><span class="o">.</span><span class="n">split</span><span class="p">(</span><span class="n">delimiter</span><span class="p">))</span>
</span><span id="hex_string__to__bytes-64"><a href="#hex_string__to__bytes-64"><span class="linenos">64</span></a>        <span class="k">return</span> <span class="n">result</span>
</span></pre></div>
...
<div class="attr function">
    ...
    <a class="headerlink" href="#solid_hex_string__to__bytes"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="solid_hex_string__to__bytes-74"><a href="#solid_hex_string__to__bytes-74"><span class="linenos">74</span></a>    <span class="k">def</span> <span class="nf">solid_hex_string__to__bytes</span><span class="p">(</span><span class="n">input_data</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span><span class="o">-&gt;</span><span class="nb">bytes</span><span class="p">:</span>
</span><span id="solid_hex_string__to__bytes-75"><a href="#solid_hex_string__to__bytes-75"><span class="linenos">75</span></a>        <span class="k">return</span> <span class="n">binascii</span><span class="o">.</span><span class="n">unhexlify</span><span class="p">(</span><span class="n">input_data</span><span class="p">)</span>
</span></pre></div>
