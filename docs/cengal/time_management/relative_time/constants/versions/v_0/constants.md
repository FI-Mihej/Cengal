...
<div>
    <main class="pdoc">
            <section class="module-info">
                    <h1 class="modulename">
cengal<wbr>.time_management<wbr>.relative_time<wbr>.constants<wbr>.versions<wbr>.v_0<wbr>.constants    </h1>
...
</span><span id="L-35"><a href="#L-35"><span class="linenos">35</span></a><span class="n">SECONDS_PER_MICROSECOND</span> <span class="o">=</span> <span class="mf">1E-6</span>
</span><span id="L-36"><a href="#L-36"><span class="linenos">36</span></a><span class="n">SECONDS_PER_MILLISECOND</span> <span class="o">=</span> <span class="mf">1E-3</span>
</span><span id="L-37"><a href="#L-37"><span class="linenos">37</span></a>
</span><span id="L-38"><a href="#L-38"><span class="linenos">38</span></a><span class="n">SECONDS_PER_MINUTE</span> <span class="o">=</span> <span class="mi">60</span>
</span><span id="L-39"><a href="#L-39"><span class="linenos">39</span></a><span class="n">SECONDS_PER_HOUR</span> <span class="o">=</span> <span class="n">SECONDS_PER_MINUTE</span> <span class="o">*</span> <span class="mi">60</span>
</span><span id="L-40"><a href="#L-40"><span class="linenos">40</span></a><span class="n">SECONDS_PER_DAY</span> <span class="o">=</span> <span class="n">SECONDS_PER_MINUTE</span> <span class="o">*</span> <span class="mi">24</span>
</span><span id="L-41"><a href="#L-41"><span class="linenos">41</span></a><span class="n">SECONDS_PER_WEEK</span> <span class="o">=</span> <span class="n">SECONDS_PER_DAY</span> <span class="o">*</span> <span class="mi">7</span>
</span></pre></div>


            </section>
                <section id="SECONDS_PER_MICROSECOND">
                    <div class="attr variable">
            <span class="name">SECONDS_PER_MICROSECOND</span>        =
<span class="default_value">1e-06</span>

        
    </div>
    <a class="headerlink" href="#SECONDS_PER_MICROSECOND"></a>
    
    

                </section>
                <section id="SECONDS_PER_MILLISECOND">
                    <div class="attr variable">
            <span class="name">SECONDS_PER_MILLISECOND</span>        =
<span class="default_value">0.001</span>

        
    </div>
    <a class="headerlink" href="#SECONDS_PER_MILLISECOND"></a>
    
    

                </section>
                <section id="SECONDS_PER_MINUTE">
                    <div class="attr variable">
            <span class="name">SECONDS_PER_MINUTE</span>        =
<span class="default_value">60</span>

        
    </div>
    <a class="headerlink" href="#SECONDS_PER_MINUTE"></a>
    
    

                </section>
                <section id="SECONDS_PER_HOUR">
                    <div class="attr variable">
            <span class="name">SECONDS_PER_HOUR</span>        =
<span class="default_value">3600</span>

        
    </div>
    <a class="headerlink" href="#SECONDS_PER_HOUR"></a>
    
    

                </section>
                <section id="SECONDS_PER_DAY">
                    <div class="attr variable">
            <span class="name">SECONDS_PER_DAY</span>        =
<span class="default_value">1440</span>

        
    </div>
    <a class="headerlink" href="#SECONDS_PER_DAY"></a>
    
    

                </section>
                <section id="SECONDS_PER_WEEK">
                    <div class="attr variable">
            <span class="name">SECONDS_PER_WEEK</span>        =
<span class="default_value">10080</span>

        
    </div>
    <a class="headerlink" href="#SECONDS_PER_WEEK"></a>
