...
<div>
    <main class="pdoc">
            <section class="module-info">
                    <h1 class="modulename">
cengal<wbr>.time_management<wbr>.cpu_clock<wbr>.versions<wbr>.v_0<wbr>.cpu_clock    </h1>

                
                        <input id="mod-cpu_clock-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">

                        <label class="view-source-button" for="mod-cpu_clock-view-source"><span>View Source</span></label>
...
<span class="default_value">3400000000</span>
    ...
    <a class="headerlink" href="#CPU_TICKS_PER_SECOND"></a>
