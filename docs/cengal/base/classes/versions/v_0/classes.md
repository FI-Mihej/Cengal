...
<div>
    <main class="pdoc">
            <section class="module-info">
                    <h1 class="modulename">
cengal<wbr>.base<wbr>.classes<wbr>.versions<wbr>.v_0<wbr>.classes    </h1>
...
</span><span id="L-35"><a href="#L-35"><span class="linenos">35</span></a><span class="k">class</span> <span class="nc">BaseClassSettings</span><span class="p">:</span>
</span><span id="L-36"><a href="#L-36"><span class="linenos">36</span></a>    <span class="k">def</span> <span class="nf">check</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
</span><span id="L-37"><a href="#L-37"><span class="linenos">37</span></a>        <span class="k">pass</span>
</span></pre></div>


            </section>
                <section id="BaseClassSettings">
                            <input id="BaseClassSettings-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr class">
            
    <span class="def">class</span>
    <span class="name">BaseClassSettings</span>:

                <label class="view-source-button" for="BaseClassSettings-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#BaseClassSettings"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="BaseClassSettings-36"><a href="#BaseClassSettings-36"><span class="linenos">36</span></a><span class="k">class</span> <span class="nc">BaseClassSettings</span><span class="p">:</span>
</span><span id="BaseClassSettings-37"><a href="#BaseClassSettings-37"><span class="linenos">37</span></a>    <span class="k">def</span> <span class="nf">check</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
</span><span id="BaseClassSettings-38"><a href="#BaseClassSettings-38"><span class="linenos">38</span></a>        <span class="k">pass</span>
</span></pre></div>


    

                            <div id="BaseClassSettings.check" class="classattr">
                                        <input id="BaseClassSettings.check-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
        ...
        <span class="name">check</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">self</span></span><span class="return-annotation">):</span></span>
                ...
                <label class="view-source-button" for="BaseClassSettings.check-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#BaseClassSettings.check"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="BaseClassSettings.check-37"><a href="#BaseClassSettings.check-37"><span class="linenos">37</span></a>    <span class="k">def</span> <span class="nf">check</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
</span><span id="BaseClassSettings.check-38"><a href="#BaseClassSettings.check-38"><span class="linenos">38</span></a>        <span class="k">pass</span>
</span></pre></div>
