...
</span><span id="L-52"><a href="#L-52"><span class="linenos"> 52</span></a><span class="k">class</span> <span class="nc">HungedCoroInfo</span><span class="p">:</span>
...
</span><span id="L-74"><a href="#L-74"><span class="linenos"> 74</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">watchdog_thread_in_work</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">False</span>
...
</span><span id="L-100"><a href="#L-100"><span class="linenos">100</span></a>        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">hunged_coro</span> <span class="ow">is</span> <span class="ow">not</span> <span class="kc">None</span><span class="p">:</span>
...
</span><span id="L-120"><a href="#L-120"><span class="linenos">120</span></a>                <span class="bp">self</span><span class="o">.</span><span class="n">watchdog_thread</span> <span class="o">=</span> <span class="n">Thread</span><span class="p">(</span><span class="n">target</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">watchdog_thread_func</span><span class="p">,</span> <span class="n">name</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">watchdog_thread_name</span><span class="p">,</span> <span class="n">daemon</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
...
</span><span id="Watchdog-62"><a href="#Watchdog-62"><span class="linenos"> 62</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">handler_set</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">False</span>
...
</span><span id="Watchdog-82"><a href="#Watchdog-82"><span class="linenos"> 82</span></a>                <span class="bp">self</span><span class="o">.</span><span class="n">check_idle_coro</span><span class="p">()</span>
...
</span><span id="Watchdog-107"><a href="#Watchdog-107"><span class="linenos">107</span></a>    
...
</span><span id="Watchdog-129"><a href="#Watchdog-129"><span class="linenos">129</span></a>    <span class="k">def</span> <span class="nf">full_processing_iteration</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
...
</span><span id="Watchdog-154"><a href="#Watchdog-154"><span class="linenos">154</span></a>    
...
</span><span id="Watchdog.__init__-70"><a href="#Watchdog.__init__-70"><span class="linenos">70</span></a>        
...
</span><span id="Watchdog.check_idle_coro-105"><a href="#Watchdog.check_idle_coro-105"><span class="linenos">105</span></a>        <span class="k">if</span> <span class="n">coro_execution_piece_delta_time</span> <span class="o">&gt;</span> <span class="bp">self</span><span class="o">.</span><span class="n">period</span><span class="p">:</span>
...
</span><span id="Watchdog.single_task_registration_or_immediate_processing-124"><a href="#Watchdog.single_task_registration_or_immediate_processing-124"><span class="linenos">124</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">period</span> <span class="o">=</span> <span class="n">period</span>
...
<div class="attr function">
    ...
    <a class="headerlink" href="#Watchdog.in_work"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="Watchdog.in_work-132"><a href="#Watchdog.in_work-132"><span class="linenos">132</span></a>    <span class="k">def</span> <span class="nf">in_work</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">bool</span><span class="p">:</span>
</span><span id="Watchdog.in_work-133"><a href="#Watchdog.in_work-133"><span class="linenos">133</span></a>        <span class="n">result</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">keyboard_interrupt_emited</span>
</span><span id="Watchdog.in_work-134"><a href="#Watchdog.in_work-134"><span class="linenos">134</span></a>        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">thrifty_in_work</span><span class="p">(</span><span class="n">result</span><span class="p">)</span>
</span></pre></div>
...
<p>Returns:
    bool: _description_</p>
                            ...
                            <div id="Watchdog.interrupt_handler" class="classattr">
                                        <input id="Watchdog.interrupt_handler-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
            
        <span class="def">def</span>
        <span class="name">interrupt_handler</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">self</span>, </span><span class="param"><span class="n">sig</span>, </span><span class="param"><span class="n">frame</span></span><span class="return-annotation">):</span></span>

                <label class="view-source-button" for="Watchdog.interrupt_handler-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#Watchdog.interrupt_handler"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="Watchdog.interrupt_handler-136"><a href="#Watchdog.interrupt_handler-136"><span class="linenos">136</span></a>    <span class="k">def</span> <span class="nf">interrupt_handler</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">sig</span><span class="p">,</span> <span class="n">frame</span><span class="p">):</span>
</span><span id="Watchdog.interrupt_handler-137"><a href="#Watchdog.interrupt_handler-137"><span class="linenos">137</span></a>        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">hunged_coro</span> <span class="ow">is</span> <span class="kc">None</span><span class="p">:</span>
</span><span id="Watchdog.interrupt_handler-138"><a href="#Watchdog.interrupt_handler-138"><span class="linenos">138</span></a>            <span class="k">return</span>
</span><span id="Watchdog.interrupt_handler-139"><a href="#Watchdog.interrupt_handler-139"><span class="linenos">139</span></a>        
</span><span id="Watchdog.interrupt_handler-140"><a href="#Watchdog.interrupt_handler-140"><span class="linenos">140</span></a>        <span class="n">loop</span><span class="p">:</span> <span class="n">CoroSchedulerType</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span>
</span><span id="Watchdog.interrupt_handler-141"><a href="#Watchdog.interrupt_handler-141"><span class="linenos">141</span></a>        <span class="k">if</span> <span class="n">get_current_coro_scheduler</span><span class="p">()</span> <span class="ow">is</span> <span class="ow">not</span> <span class="n">loop</span><span class="p">:</span>
</span><span id="Watchdog.interrupt_handler-142"><a href="#Watchdog.interrupt_handler-142"><span class="linenos">142</span></a>            <span class="k">return</span>
</span><span id="Watchdog.interrupt_handler-143"><a href="#Watchdog.interrupt_handler-143"><span class="linenos">143</span></a>        
</span><span id="Watchdog.interrupt_handler-144"><a href="#Watchdog.interrupt_handler-144"><span class="linenos">144</span></a>        <span class="k">if</span> <span class="n">current_interface</span><span class="p">()</span> <span class="ow">is</span> <span class="ow">not</span> <span class="bp">self</span><span class="o">.</span><span class="n">hunged_coro</span><span class="o">.</span><span class="n">interface</span><span class="p">:</span>
</span><span id="Watchdog.interrupt_handler-145"><a href="#Watchdog.interrupt_handler-145"><span class="linenos">145</span></a>            <span class="k">return</span>
</span><span id="Watchdog.interrupt_handler-146"><a href="#Watchdog.interrupt_handler-146"><span class="linenos">146</span></a>
</span><span id="Watchdog.interrupt_handler-147"><a href="#Watchdog.interrupt_handler-147"><span class="linenos">147</span></a>        <span class="k">if</span> <span class="n">loop</span><span class="o">.</span><span class="n">current_coro_start_time</span> <span class="o">!=</span> <span class="bp">self</span><span class="o">.</span><span class="n">hunged_coro</span><span class="o">.</span><span class="n">coro_start_time</span><span class="p">:</span>
</span><span id="Watchdog.interrupt_handler-148"><a href="#Watchdog.interrupt_handler-148"><span class="linenos">148</span></a>            <span class="k">return</span>
</span><span id="Watchdog.interrupt_handler-149"><a href="#Watchdog.interrupt_handler-149"><span class="linenos">149</span></a>
</span><span id="Watchdog.interrupt_handler-150"><a href="#Watchdog.interrupt_handler-150"><span class="linenos">150</span></a>        <span class="k">try</span><span class="p">:</span>
</span><span id="Watchdog.interrupt_handler-151"><a href="#Watchdog.interrupt_handler-151"><span class="linenos">151</span></a>            <span class="k">raise</span> <span class="n">WatchdogTimeoutError</span>
</span><span id="Watchdog.interrupt_handler-152"><a href="#Watchdog.interrupt_handler-152"><span class="linenos">152</span></a>        <span class="k">finally</span><span class="p">:</span>
</span><span id="Watchdog.interrupt_handler-153"><a href="#Watchdog.interrupt_handler-153"><span class="linenos">153</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">hunged_coro</span> <span class="o">=</span> <span class="kc">None</span>
</span></pre></div>
                            ...
                            <div id="Watchdog.destroy" class="classattr">
                                        <input id="Watchdog.destroy-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
        ...
        <span class="name">destroy</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">self</span></span><span class="return-annotation">):</span></span>
                ...
                <label class="view-source-button" for="Watchdog.destroy-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#Watchdog.destroy"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="Watchdog.destroy-155"><a href="#Watchdog.destroy-155"><span class="linenos">155</span></a>    <span class="k">def</span> <span class="nf">destroy</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
</span><span id="Watchdog.destroy-156"><a href="#Watchdog.destroy-156"><span class="linenos">156</span></a>        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">watchdog_thread</span> <span class="ow">is</span> <span class="ow">not</span> <span class="kc">None</span><span class="p">:</span>
</span><span id="Watchdog.destroy-157"><a href="#Watchdog.destroy-157"><span class="linenos">157</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">watchdog_thread_allowed</span> <span class="o">=</span> <span class="kc">False</span>
</span><span id="Watchdog.destroy-158"><a href="#Watchdog.destroy-158"><span class="linenos">158</span></a>            <span class="k">while</span> <span class="bp">self</span><span class="o">.</span><span class="n">watchdog_thread_in_work</span><span class="p">:</span>
</span><span id="Watchdog.destroy-159"><a href="#Watchdog.destroy-159"><span class="linenos">159</span></a>                <span class="n">sleep</span><span class="p">(</span><span class="mf">0.0001</span><span class="p">,</span> <span class="n">high_cpu_utilisation_mode</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
</span><span id="Watchdog.destroy-160"><a href="#Watchdog.destroy-160"><span class="linenos">160</span></a>            
</span><span id="Watchdog.destroy-161"><a href="#Watchdog.destroy-161"><span class="linenos">161</span></a>            <span class="c1"># self.watchdog_thread.join()  # we don ot need this since it is a daemon thread</span>
</span><span id="Watchdog.destroy-162"><a href="#Watchdog.destroy-162"><span class="linenos">162</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">watchdog_thread</span> <span class="o">=</span> <span class="kc">None</span>
</span><span id="Watchdog.destroy-163"><a href="#Watchdog.destroy-163"><span class="linenos">163</span></a>
</span><span id="Watchdog.destroy-164"><a href="#Watchdog.destroy-164"><span class="linenos">164</span></a>        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">handler_set</span><span class="p">:</span>
</span><span id="Watchdog.destroy-165"><a href="#Watchdog.destroy-165"><span class="linenos">165</span></a>            <span class="n">signal</span><span class="o">.</span><span class="n">signal</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">raised_signal</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">previous_handler</span><span class="p">)</span>
</span><span id="Watchdog.destroy-166"><a href="#Watchdog.destroy-166"><span class="linenos">166</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">handler_set</span> <span class="o">=</span> <span class="kc">False</span>
</span></pre></div>
                            ...
                            <div class="inherited">
                                ...
                                <dd id="Watchdog.current_caller_coro_info" class="variable">current_caller_coro_info</dd>
                <dd id="Watchdog.iteration" class="function">iteration</dd>
                <dd id="Watchdog.make_response" class="function">make_response</dd>
                <dd id="Watchdog.register_response" class="function">register_response</dd>
                <dd id="Watchdog.put_task" class="function">put_task</dd>
                <dd id="Watchdog.resolve_request" class="function">resolve_request</dd>
                <dd id="Watchdog.try_resolve_request" class="function">try_resolve_request</dd>
                <dd id="Watchdog.in_forground_work" class="function">in_forground_work</dd>
                <dd id="Watchdog.thrifty_in_work" class="function">thrifty_in_work</dd>
                <dd id="Watchdog.time_left_before_next_event" class="function">time_left_before_next_event</dd>
                <dd id="Watchdog.is_low_latency" class="function">is_low_latency</dd>
                <dd id="Watchdog.make_live" class="function">make_live</dd>
                <dd id="Watchdog.make_dead" class="function">make_dead</dd>
                <dd id="Watchdog.service_id_impl" class="function">service_id_impl</dd>
                <dd id="Watchdog.service_id" class="function">service_id</dd>
