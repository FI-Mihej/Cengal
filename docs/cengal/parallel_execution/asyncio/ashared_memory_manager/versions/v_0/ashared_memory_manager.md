...
</span><span id="L-55"><a href="#L-55"><span class="linenos"> 55</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">ashared_memory_management</span><span class="p">:</span> <span class="s1">&#39;ASharedMemoryManager&#39;</span> <span class="o">=</span> <span class="n">ashared_memory_management</span>
...
</span><span id="L-74"><a href="#L-74"><span class="linenos"> 74</span></a>    <span class="k">async</span> <span class="k">def</span> <span class="fm">__aexit__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">exc_type</span><span class="p">,</span> <span class="n">exc_val</span><span class="p">,</span> <span class="n">exc_tb</span><span class="p">):</span>
...
</span><span id="L-97"><a href="#L-97"><span class="linenos"> 97</span></a>    <span class="k">def</span> <span class="nf">_loop</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
...
</span><span id="L-124"><a href="#L-124"><span class="linenos">124</span></a><span class="k">class</span> <span class="nc">ASharedMemoryManager</span><span class="p">:</span>
...
</span><span id="L-140"><a href="#L-140"><span class="linenos">140</span></a>    <span class="k">async</span> <span class="k">def</span> <span class="fm">__aenter__</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="s1">&#39;ASharedMemoryManager&#39;</span><span class="p">:</span>
...
</span><span id="L-164"><a href="#L-164"><span class="linenos">164</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">_asleep_func</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_asleep_func</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_sleep_for_minimal_time</span>
...
</span><span id="L-186"><a href="#L-186"><span class="linenos">186</span></a>    <span class="k">def</span> <span class="nf">run</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
...
</span><span id="L-208"><a href="#L-208"><span class="linenos">208</span></a>            <span class="k">async</span> <span class="k">with</span> <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="p">:</span>
...
</span><span id="L-228"><a href="#L-228"><span class="linenos">228</span></a>                                    <span class="n">request_from_client</span><span class="o">.</span><span class="n">set_result</span><span class="p">(</span><span class="n">client_ready_future</span><span class="p">)</span>
...
</span><span id="L-252"><a href="#L-252"><span class="linenos">252</span></a><span class="n">ASMM</span> <span class="o">=</span> <span class="n">ASharedMemoryManager</span>
</span></pre></div>
...
</span><span id="ASharedMemoryContextManager-64"><a href="#ASharedMemoryContextManager-64"><span class="linenos"> 64</span></a>
...
</span><span id="ASharedMemoryContextManager-83"><a href="#ASharedMemoryContextManager-83"><span class="linenos"> 83</span></a>        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">ashared_memory_management</span><span class="o">.</span><span class="n">save_cpu_time</span>
...
</span><span id="ASharedMemoryContextManager-102"><a href="#ASharedMemoryContextManager-102"><span class="linenos">102</span></a>        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">ashared_memory_management</span><span class="o">.</span><span class="n">close</span><span class="p">()</span>
...
</span><span id="ASharedMemoryContextManager.__init__-63"><a href="#ASharedMemoryContextManager.__init__-63"><span class="linenos">63</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">_entered</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">False</span>
</span></pre></div>
...
<div class="attr function">
        ...
        <span class="name">close</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">self</span></span><span class="return-annotation">) -> <span class="n">Union</span><span class="p">[</span><span class="n">_asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">,</span> <span class="n">NoneType</span><span class="p">]</span>:</span></span>
                ...
                <label class="view-source-button" for="ASharedMemoryContextManager.close-view-source"><span>View Source</span></label>
...
<div class="attr function">
        ...
        <span class="name">has_messages</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">self</span></span><span class="return-annotation">):</span></span>
                ...
                <label class="view-source-button" for="ASharedMemoryContextManager.has_messages-view-source"><span>View Source</span></label>
...
<div class="attr function">
        ...
        <span class="name">anyway</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">self</span></span><span class="return-annotation">):</span></span>
                ...
                <label class="view-source-button" for="ASharedMemoryContextManager.anyway-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#ASharedMemoryContextManager.anyway"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="ASharedMemoryContextManager.anyway-117"><a href="#ASharedMemoryContextManager.anyway-117"><span class="linenos">117</span></a>    <span class="k">def</span> <span class="nf">anyway</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
</span><span id="ASharedMemoryContextManager.anyway-118"><a href="#ASharedMemoryContextManager.anyway-118"><span class="linenos">118</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">if_has_messages_value</span> <span class="o">=</span> <span class="kc">False</span>
</span><span id="ASharedMemoryContextManager.anyway-119"><a href="#ASharedMemoryContextManager.anyway-119"><span class="linenos">119</span></a>        <span class="k">return</span> <span class="bp">self</span>
</span></pre></div>
                ...
                <section id="ASMCM">
                    <div class="attr variable">
            <span class="name">ASMCM</span>        =
<input id="ASMCM-view-value" class="view-value-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
            <label class="view-value-button pdoc-button" for="ASMCM-view-value"></label><span class="default_value">&lt;class &#39;<a href="#ASharedMemoryContextManager">ASharedMemoryContextManager</a>&#39;&gt;</span>

        
    </div>
    <a class="headerlink" href="#ASMCM"></a>
    
    

                </section>
                <section id="ASharedMemoryManager">
                            <input id="ASharedMemoryManager-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr class">
            
    <span class="def">class</span>
    <span class="name">ASharedMemoryManager</span>:

                <label class="view-source-button" for="ASharedMemoryManager-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#ASharedMemoryManager"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="ASharedMemoryManager-125"><a href="#ASharedMemoryManager-125"><span class="linenos">125</span></a><span class="k">class</span> <span class="nc">ASharedMemoryManager</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-126"><a href="#ASharedMemoryManager-126"><span class="linenos">126</span></a>    <span class="k">def</span> <span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">shared_memory</span><span class="p">:</span> <span class="n">SharedMemory</span><span class="p">,</span> <span class="n">save_cpu_time</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">False</span><span class="p">,</span> <span class="n">time_limit</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="n">RationalNumber</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">):</span>
</span><span id="ASharedMemoryManager-127"><a href="#ASharedMemoryManager-127"><span class="linenos">127</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="p">:</span> <span class="n">SharedMemory</span> <span class="o">=</span> <span class="n">shared_memory</span>
</span><span id="ASharedMemoryManager-128"><a href="#ASharedMemoryManager-128"><span class="linenos">128</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">_save_cpu_time</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">None</span>
</span><span id="ASharedMemoryManager-129"><a href="#ASharedMemoryManager-129"><span class="linenos">129</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">_asleep_func</span><span class="p">:</span> <span class="n">Coroutine</span> <span class="o">=</span> <span class="kc">None</span>
</span><span id="ASharedMemoryManager-130"><a href="#ASharedMemoryManager-130"><span class="linenos">130</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">save_cpu_time</span> <span class="o">=</span> <span class="n">save_cpu_time</span>
</span><span id="ASharedMemoryManager-131"><a href="#ASharedMemoryManager-131"><span class="linenos">131</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">time_limit</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="n">RationalNumber</span><span class="p">]</span> <span class="o">=</span> <span class="n">time_limit</span>
</span><span id="ASharedMemoryManager-132"><a href="#ASharedMemoryManager-132"><span class="linenos">132</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span><span class="p">:</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">AbstractEventLoop</span> <span class="o">=</span> <span class="kc">None</span>
</span><span id="ASharedMemoryManager-133"><a href="#ASharedMemoryManager-133"><span class="linenos">133</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">requests_from_clients</span><span class="p">:</span> <span class="n">List</span><span class="p">[</span><span class="n">asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">]</span> <span class="o">=</span> <span class="nb">list</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-134"><a href="#ASharedMemoryManager-134"><span class="linenos">134</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">clients_readyness</span><span class="p">:</span> <span class="n">List</span><span class="p">[</span><span class="n">asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">]</span> <span class="o">=</span> <span class="nb">list</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-135"><a href="#ASharedMemoryManager-135"><span class="linenos">135</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">closed</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">False</span>
</span><span id="ASharedMemoryManager-136"><a href="#ASharedMemoryManager-136"><span class="linenos">136</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">close_requested</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">False</span>
</span><span id="ASharedMemoryManager-137"><a href="#ASharedMemoryManager-137"><span class="linenos">137</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">close_requests</span><span class="p">:</span> <span class="n">List</span><span class="p">[</span><span class="n">asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">]</span> <span class="o">=</span> <span class="nb">list</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-138"><a href="#ASharedMemoryManager-138"><span class="linenos">138</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">has_messages_requests</span><span class="p">:</span> <span class="n">List</span><span class="p">[</span><span class="n">asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">]</span> <span class="o">=</span> <span class="nb">list</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-139"><a href="#ASharedMemoryManager-139"><span class="linenos">139</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">worker_task</span><span class="p">:</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">Task</span> <span class="o">=</span> <span class="kc">None</span>
</span><span id="ASharedMemoryManager-140"><a href="#ASharedMemoryManager-140"><span class="linenos">140</span></a>    
</span><span id="ASharedMemoryManager-141"><a href="#ASharedMemoryManager-141"><span class="linenos">141</span></a>    <span class="k">async</span> <span class="k">def</span> <span class="fm">__aenter__</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="s1">&#39;ASharedMemoryManager&#39;</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-142"><a href="#ASharedMemoryManager-142"><span class="linenos">142</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">closed</span> <span class="o">=</span> <span class="kc">False</span>
</span><span id="ASharedMemoryManager-143"><a href="#ASharedMemoryManager-143"><span class="linenos">143</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">run</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-144"><a href="#ASharedMemoryManager-144"><span class="linenos">144</span></a>        <span class="k">return</span> <span class="bp">self</span>
</span><span id="ASharedMemoryManager-145"><a href="#ASharedMemoryManager-145"><span class="linenos">145</span></a>    
</span><span id="ASharedMemoryManager-146"><a href="#ASharedMemoryManager-146"><span class="linenos">146</span></a>    <span class="k">async</span> <span class="k">def</span> <span class="fm">__aexit__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">exc_type</span><span class="p">,</span> <span class="n">exc_val</span><span class="p">,</span> <span class="n">exc_tb</span><span class="p">):</span>
</span><span id="ASharedMemoryManager-147"><a href="#ASharedMemoryManager-147"><span class="linenos">147</span></a>        <span class="k">await</span> <span class="bp">self</span><span class="o">.</span><span class="n">aclose</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-148"><a href="#ASharedMemoryManager-148"><span class="linenos">148</span></a>
</span><span id="ASharedMemoryManager-149"><a href="#ASharedMemoryManager-149"><span class="linenos">149</span></a>    <span class="k">async</span> <span class="k">def</span> <span class="nf">_sleep_till_next_loop_iteration</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
</span><span id="ASharedMemoryManager-150"><a href="#ASharedMemoryManager-150"><span class="linenos">150</span></a>        <span class="k">await</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">sleep</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-151"><a href="#ASharedMemoryManager-151"><span class="linenos">151</span></a>        <span class="n">mm_pause</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-152"><a href="#ASharedMemoryManager-152"><span class="linenos">152</span></a>    
</span><span id="ASharedMemoryManager-153"><a href="#ASharedMemoryManager-153"><span class="linenos">153</span></a>    <span class="k">async</span> <span class="k">def</span> <span class="nf">_sleep_for_minimal_time</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
</span><span id="ASharedMemoryManager-154"><a href="#ASharedMemoryManager-154"><span class="linenos">154</span></a>        <span class="k">await</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">sleep</span><span class="p">(</span><span class="n">get_usable_min_sleep_interval</span><span class="p">())</span>
</span><span id="ASharedMemoryManager-155"><a href="#ASharedMemoryManager-155"><span class="linenos">155</span></a>        <span class="n">mm_pause</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-156"><a href="#ASharedMemoryManager-156"><span class="linenos">156</span></a>    
</span><span id="ASharedMemoryManager-157"><a href="#ASharedMemoryManager-157"><span class="linenos">157</span></a>    <span class="nd">@property</span>
</span><span id="ASharedMemoryManager-158"><a href="#ASharedMemoryManager-158"><span class="linenos">158</span></a>    <span class="k">def</span> <span class="nf">save_cpu_time</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">bool</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-159"><a href="#ASharedMemoryManager-159"><span class="linenos">159</span></a>        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_save_cpu_time</span>
</span><span id="ASharedMemoryManager-160"><a href="#ASharedMemoryManager-160"><span class="linenos">160</span></a>    
</span><span id="ASharedMemoryManager-161"><a href="#ASharedMemoryManager-161"><span class="linenos">161</span></a>    <span class="nd">@save_cpu_time</span><span class="o">.</span><span class="n">setter</span>
</span><span id="ASharedMemoryManager-162"><a href="#ASharedMemoryManager-162"><span class="linenos">162</span></a>    <span class="k">def</span> <span class="nf">save_cpu_time</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">value</span><span class="p">:</span> <span class="nb">bool</span><span class="p">):</span>
</span><span id="ASharedMemoryManager-163"><a href="#ASharedMemoryManager-163"><span class="linenos">163</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">_save_cpu_time</span> <span class="o">=</span> <span class="n">value</span>
</span><span id="ASharedMemoryManager-164"><a href="#ASharedMemoryManager-164"><span class="linenos">164</span></a>        <span class="k">if</span> <span class="n">value</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-165"><a href="#ASharedMemoryManager-165"><span class="linenos">165</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">_asleep_func</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_asleep_func</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_sleep_for_minimal_time</span>
</span><span id="ASharedMemoryManager-166"><a href="#ASharedMemoryManager-166"><span class="linenos">166</span></a>        <span class="k">else</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-167"><a href="#ASharedMemoryManager-167"><span class="linenos">167</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">_asleep_func</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_asleep_func</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_sleep_till_next_loop_iteration</span>
</span><span id="ASharedMemoryManager-168"><a href="#ASharedMemoryManager-168"><span class="linenos">168</span></a>
</span><span id="ASharedMemoryManager-169"><a href="#ASharedMemoryManager-169"><span class="linenos">169</span></a>    <span class="k">async</span> <span class="k">def</span> <span class="nf">aclose</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-170"><a href="#ASharedMemoryManager-170"><span class="linenos">170</span></a>        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">closed</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-171"><a href="#ASharedMemoryManager-171"><span class="linenos">171</span></a>            <span class="k">return</span>
</span><span id="ASharedMemoryManager-172"><a href="#ASharedMemoryManager-172"><span class="linenos">172</span></a>        
</span><span id="ASharedMemoryManager-173"><a href="#ASharedMemoryManager-173"><span class="linenos">173</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">close_requested</span> <span class="o">=</span> <span class="kc">True</span>
</span><span id="ASharedMemoryManager-174"><a href="#ASharedMemoryManager-174"><span class="linenos">174</span></a>        <span class="n">close_request</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span><span class="o">.</span><span class="n">create_future</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-175"><a href="#ASharedMemoryManager-175"><span class="linenos">175</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">close_requests</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">close_request</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-176"><a href="#ASharedMemoryManager-176"><span class="linenos">176</span></a>        <span class="k">await</span> <span class="n">close_request</span>
</span><span id="ASharedMemoryManager-177"><a href="#ASharedMemoryManager-177"><span class="linenos">177</span></a>
</span><span id="ASharedMemoryManager-178"><a href="#ASharedMemoryManager-178"><span class="linenos">178</span></a>    <span class="k">def</span> <span class="nf">close</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Optional</span><span class="p">[</span><span class="n">asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">]:</span>
</span><span id="ASharedMemoryManager-179"><a href="#ASharedMemoryManager-179"><span class="linenos">179</span></a>        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">closed</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-180"><a href="#ASharedMemoryManager-180"><span class="linenos">180</span></a>            <span class="k">return</span> <span class="kc">None</span>
</span><span id="ASharedMemoryManager-181"><a href="#ASharedMemoryManager-181"><span class="linenos">181</span></a>
</span><span id="ASharedMemoryManager-182"><a href="#ASharedMemoryManager-182"><span class="linenos">182</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">close_requested</span> <span class="o">=</span> <span class="kc">True</span>
</span><span id="ASharedMemoryManager-183"><a href="#ASharedMemoryManager-183"><span class="linenos">183</span></a>        <span class="n">close_request</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span><span class="o">.</span><span class="n">create_future</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-184"><a href="#ASharedMemoryManager-184"><span class="linenos">184</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">close_requests</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">close_request</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-185"><a href="#ASharedMemoryManager-185"><span class="linenos">185</span></a>        <span class="k">return</span> <span class="n">close_request</span>
</span><span id="ASharedMemoryManager-186"><a href="#ASharedMemoryManager-186"><span class="linenos">186</span></a>    
</span><span id="ASharedMemoryManager-187"><a href="#ASharedMemoryManager-187"><span class="linenos">187</span></a>    <span class="k">def</span> <span class="nf">run</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
</span><span id="ASharedMemoryManager-188"><a href="#ASharedMemoryManager-188"><span class="linenos">188</span></a>        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">worker_task</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-189"><a href="#ASharedMemoryManager-189"><span class="linenos">189</span></a>            <span class="k">return</span>
</span><span id="ASharedMemoryManager-190"><a href="#ASharedMemoryManager-190"><span class="linenos">190</span></a>        
</span><span id="ASharedMemoryManager-191"><a href="#ASharedMemoryManager-191"><span class="linenos">191</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span> <span class="o">=</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">get_event_loop</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-192"><a href="#ASharedMemoryManager-192"><span class="linenos">192</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">worker_task</span> <span class="o">=</span> <span class="n">create_task_awaitable</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">worker</span><span class="p">())</span>
</span><span id="ASharedMemoryManager-193"><a href="#ASharedMemoryManager-193"><span class="linenos">193</span></a>    
</span><span id="ASharedMemoryManager-194"><a href="#ASharedMemoryManager-194"><span class="linenos">194</span></a>    <span class="k">def</span> <span class="nf">get_in_line</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-195"><a href="#ASharedMemoryManager-195"><span class="linenos">195</span></a>        <span class="n">get_in_line_future</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span><span class="o">.</span><span class="n">create_future</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-196"><a href="#ASharedMemoryManager-196"><span class="linenos">196</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">requests_from_clients</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">get_in_line_future</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-197"><a href="#ASharedMemoryManager-197"><span class="linenos">197</span></a>        <span class="k">return</span> <span class="n">get_in_line_future</span>
</span><span id="ASharedMemoryManager-198"><a href="#ASharedMemoryManager-198"><span class="linenos">198</span></a>
</span><span id="ASharedMemoryManager-199"><a href="#ASharedMemoryManager-199"><span class="linenos">199</span></a>    <span class="k">async</span> <span class="k">def</span> <span class="nf">has_messages</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
</span><span id="ASharedMemoryManager-200"><a href="#ASharedMemoryManager-200"><span class="linenos">200</span></a>        <span class="n">has_messages_future</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span><span class="o">.</span><span class="n">create_future</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-201"><a href="#ASharedMemoryManager-201"><span class="linenos">201</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">has_messages_requests</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">has_messages_future</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-202"><a href="#ASharedMemoryManager-202"><span class="linenos">202</span></a>        <span class="k">return</span> <span class="k">await</span> <span class="n">has_messages_future</span>
</span><span id="ASharedMemoryManager-203"><a href="#ASharedMemoryManager-203"><span class="linenos">203</span></a>    
</span><span id="ASharedMemoryManager-204"><a href="#ASharedMemoryManager-204"><span class="linenos">204</span></a>    <span class="k">def</span> <span class="fm">__call__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">if_has_messages</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="nb">bool</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">ASharedMemoryContextManager</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-205"><a href="#ASharedMemoryManager-205"><span class="linenos">205</span></a>        <span class="k">return</span> <span class="n">ASharedMemoryContextManager</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">if_has_messages</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-206"><a href="#ASharedMemoryManager-206"><span class="linenos">206</span></a>    
</span><span id="ASharedMemoryManager-207"><a href="#ASharedMemoryManager-207"><span class="linenos">207</span></a>    <span class="k">async</span> <span class="k">def</span> <span class="nf">worker</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
</span><span id="ASharedMemoryManager-208"><a href="#ASharedMemoryManager-208"><span class="linenos">208</span></a>        <span class="k">try</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-209"><a href="#ASharedMemoryManager-209"><span class="linenos">209</span></a>            <span class="k">async</span> <span class="k">with</span> <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-210"><a href="#ASharedMemoryManager-210"><span class="linenos">210</span></a>                <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">create</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-211"><a href="#ASharedMemoryManager-211"><span class="linenos">211</span></a>                    <span class="k">await</span> <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">await_consumer_ready</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">time_limit</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-212"><a href="#ASharedMemoryManager-212"><span class="linenos">212</span></a>                <span class="k">else</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-213"><a href="#ASharedMemoryManager-213"><span class="linenos">213</span></a>                    <span class="k">await</span> <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">ainit_consumer</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">time_limit</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-214"><a href="#ASharedMemoryManager-214"><span class="linenos">214</span></a>                
</span><span id="ASharedMemoryManager-215"><a href="#ASharedMemoryManager-215"><span class="linenos">215</span></a>                <span class="k">while</span> <span class="ow">not</span> <span class="bp">self</span><span class="o">.</span><span class="n">close_requested</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-216"><a href="#ASharedMemoryManager-216"><span class="linenos">216</span></a>                    <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">requests_from_clients</span> <span class="ow">or</span> <span class="bp">self</span><span class="o">.</span><span class="n">has_messages_requests</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-217"><a href="#ASharedMemoryManager-217"><span class="linenos">217</span></a>                        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">get_in_line</span><span class="p">():</span>
</span><span id="ASharedMemoryManager-218"><a href="#ASharedMemoryManager-218"><span class="linenos">218</span></a>                            <span class="k">try</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-219"><a href="#ASharedMemoryManager-219"><span class="linenos">219</span></a>                                <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">has_messages</span><span class="p">():</span>
</span><span id="ASharedMemoryManager-220"><a href="#ASharedMemoryManager-220"><span class="linenos">220</span></a>                                    <span class="n">has_messages_requests_buff</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">has_messages_requests</span>
</span><span id="ASharedMemoryManager-221"><a href="#ASharedMemoryManager-221"><span class="linenos">221</span></a>                                    <span class="bp">self</span><span class="o">.</span><span class="n">has_messages_requests</span> <span class="o">=</span> <span class="nb">list</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-222"><a href="#ASharedMemoryManager-222"><span class="linenos">222</span></a>                                    <span class="k">for</span> <span class="n">has_messages_request</span> <span class="ow">in</span> <span class="n">has_messages_requests_buff</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-223"><a href="#ASharedMemoryManager-223"><span class="linenos">223</span></a>                                        <span class="n">has_messages_request</span><span class="o">.</span><span class="n">set_result</span><span class="p">(</span><span class="kc">True</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-224"><a href="#ASharedMemoryManager-224"><span class="linenos">224</span></a>                                
</span><span id="ASharedMemoryManager-225"><a href="#ASharedMemoryManager-225"><span class="linenos">225</span></a>                                <span class="n">requests_from_clients_buff</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">requests_from_clients</span>
</span><span id="ASharedMemoryManager-226"><a href="#ASharedMemoryManager-226"><span class="linenos">226</span></a>                                <span class="bp">self</span><span class="o">.</span><span class="n">requests_from_clients</span> <span class="o">=</span> <span class="nb">list</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-227"><a href="#ASharedMemoryManager-227"><span class="linenos">227</span></a>                                <span class="k">for</span> <span class="n">request_from_client</span> <span class="ow">in</span> <span class="n">requests_from_clients_buff</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-228"><a href="#ASharedMemoryManager-228"><span class="linenos">228</span></a>                                    <span class="n">client_ready_future</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span><span class="o">.</span><span class="n">create_future</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-229"><a href="#ASharedMemoryManager-229"><span class="linenos">229</span></a>                                    <span class="n">request_from_client</span><span class="o">.</span><span class="n">set_result</span><span class="p">(</span><span class="n">client_ready_future</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-230"><a href="#ASharedMemoryManager-230"><span class="linenos">230</span></a>                                    <span class="bp">self</span><span class="o">.</span><span class="n">clients_readyness</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">client_ready_future</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-231"><a href="#ASharedMemoryManager-231"><span class="linenos">231</span></a>                                
</span><span id="ASharedMemoryManager-232"><a href="#ASharedMemoryManager-232"><span class="linenos">232</span></a>                                <span class="n">client_results</span> <span class="o">=</span> <span class="k">await</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">gather</span><span class="p">(</span><span class="o">*</span><span class="bp">self</span><span class="o">.</span><span class="n">clients_readyness</span><span class="p">,</span> <span class="n">return_exceptions</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-233"><a href="#ASharedMemoryManager-233"><span class="linenos">233</span></a>                                <span class="bp">self</span><span class="o">.</span><span class="n">clients_readyness</span><span class="o">.</span><span class="n">clear</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-234"><a href="#ASharedMemoryManager-234"><span class="linenos">234</span></a>                            <span class="k">finally</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-235"><a href="#ASharedMemoryManager-235"><span class="linenos">235</span></a>                                <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">release</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-236"><a href="#ASharedMemoryManager-236"><span class="linenos">236</span></a>                            
</span><span id="ASharedMemoryManager-237"><a href="#ASharedMemoryManager-237"><span class="linenos">237</span></a>                            <span class="k">if</span> <span class="nb">any</span><span class="p">(</span><span class="n">client_results</span><span class="p">):</span>
</span><span id="ASharedMemoryManager-238"><a href="#ASharedMemoryManager-238"><span class="linenos">238</span></a>                                <span class="k">await</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">sleep</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-239"><a href="#ASharedMemoryManager-239"><span class="linenos">239</span></a>                            <span class="k">else</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-240"><a href="#ASharedMemoryManager-240"><span class="linenos">240</span></a>                                <span class="k">await</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">sleep</span><span class="p">(</span><span class="n">get_usable_min_sleep_interval</span><span class="p">())</span>
</span><span id="ASharedMemoryManager-241"><a href="#ASharedMemoryManager-241"><span class="linenos">241</span></a>                    <span class="k">else</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-242"><a href="#ASharedMemoryManager-242"><span class="linenos">242</span></a>                        <span class="k">await</span> <span class="bp">self</span><span class="o">.</span><span class="n">_asleep_func</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-243"><a href="#ASharedMemoryManager-243"><span class="linenos">243</span></a>        <span class="k">finally</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-244"><a href="#ASharedMemoryManager-244"><span class="linenos">244</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">closed</span> <span class="o">=</span> <span class="kc">True</span>
</span><span id="ASharedMemoryManager-245"><a href="#ASharedMemoryManager-245"><span class="linenos">245</span></a>            <span class="k">for</span> <span class="n">close_request</span> <span class="ow">in</span> <span class="bp">self</span><span class="o">.</span><span class="n">close_requests</span><span class="p">:</span>
</span><span id="ASharedMemoryManager-246"><a href="#ASharedMemoryManager-246"><span class="linenos">246</span></a>                <span class="n">close_request</span><span class="o">.</span><span class="n">set_result</span><span class="p">(</span><span class="kc">None</span><span class="p">)</span>
</span><span id="ASharedMemoryManager-247"><a href="#ASharedMemoryManager-247"><span class="linenos">247</span></a>            
</span><span id="ASharedMemoryManager-248"><a href="#ASharedMemoryManager-248"><span class="linenos">248</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">close_requests</span><span class="o">.</span><span class="n">clear</span><span class="p">()</span>
</span><span id="ASharedMemoryManager-249"><a href="#ASharedMemoryManager-249"><span class="linenos">249</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">close_requested</span> <span class="o">=</span> <span class="kc">False</span>
</span><span id="ASharedMemoryManager-250"><a href="#ASharedMemoryManager-250"><span class="linenos">250</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">worker_task</span> <span class="o">=</span> <span class="kc">None</span>
</span></pre></div>


    

                            <div id="ASharedMemoryManager.__init__" class="classattr">
...
<div class="attr function">
    ...
    <a class="headerlink" href="#ASharedMemoryManager.__init__"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="ASharedMemoryManager.__init__-126"><a href="#ASharedMemoryManager.__init__-126"><span class="linenos">126</span></a>    <span class="k">def</span> <span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">shared_memory</span><span class="p">:</span> <span class="n">SharedMemory</span><span class="p">,</span> <span class="n">save_cpu_time</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">False</span><span class="p">,</span> <span class="n">time_limit</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="n">RationalNumber</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">):</span>
</span><span id="ASharedMemoryManager.__init__-127"><a href="#ASharedMemoryManager.__init__-127"><span class="linenos">127</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="p">:</span> <span class="n">SharedMemory</span> <span class="o">=</span> <span class="n">shared_memory</span>
</span><span id="ASharedMemoryManager.__init__-128"><a href="#ASharedMemoryManager.__init__-128"><span class="linenos">128</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">_save_cpu_time</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">None</span>
</span><span id="ASharedMemoryManager.__init__-129"><a href="#ASharedMemoryManager.__init__-129"><span class="linenos">129</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">_asleep_func</span><span class="p">:</span> <span class="n">Coroutine</span> <span class="o">=</span> <span class="kc">None</span>
</span><span id="ASharedMemoryManager.__init__-130"><a href="#ASharedMemoryManager.__init__-130"><span class="linenos">130</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">save_cpu_time</span> <span class="o">=</span> <span class="n">save_cpu_time</span>
</span><span id="ASharedMemoryManager.__init__-131"><a href="#ASharedMemoryManager.__init__-131"><span class="linenos">131</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">time_limit</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="n">RationalNumber</span><span class="p">]</span> <span class="o">=</span> <span class="n">time_limit</span>
</span><span id="ASharedMemoryManager.__init__-132"><a href="#ASharedMemoryManager.__init__-132"><span class="linenos">132</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span><span class="p">:</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">AbstractEventLoop</span> <span class="o">=</span> <span class="kc">None</span>
</span><span id="ASharedMemoryManager.__init__-133"><a href="#ASharedMemoryManager.__init__-133"><span class="linenos">133</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">requests_from_clients</span><span class="p">:</span> <span class="n">List</span><span class="p">[</span><span class="n">asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">]</span> <span class="o">=</span> <span class="nb">list</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.__init__-134"><a href="#ASharedMemoryManager.__init__-134"><span class="linenos">134</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">clients_readyness</span><span class="p">:</span> <span class="n">List</span><span class="p">[</span><span class="n">asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">]</span> <span class="o">=</span> <span class="nb">list</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.__init__-135"><a href="#ASharedMemoryManager.__init__-135"><span class="linenos">135</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">closed</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">False</span>
</span><span id="ASharedMemoryManager.__init__-136"><a href="#ASharedMemoryManager.__init__-136"><span class="linenos">136</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">close_requested</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">False</span>
</span><span id="ASharedMemoryManager.__init__-137"><a href="#ASharedMemoryManager.__init__-137"><span class="linenos">137</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">close_requests</span><span class="p">:</span> <span class="n">List</span><span class="p">[</span><span class="n">asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">]</span> <span class="o">=</span> <span class="nb">list</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.__init__-138"><a href="#ASharedMemoryManager.__init__-138"><span class="linenos">138</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">has_messages_requests</span><span class="p">:</span> <span class="n">List</span><span class="p">[</span><span class="n">asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">]</span> <span class="o">=</span> <span class="nb">list</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.__init__-139"><a href="#ASharedMemoryManager.__init__-139"><span class="linenos">139</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">worker_task</span><span class="p">:</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">Task</span> <span class="o">=</span> <span class="kc">None</span>
</span></pre></div>
    ...
    <a class="headerlink" href="#ASharedMemoryManager.shared_memory"></a>
    
    

                            </div>
                            <div id="ASharedMemoryManager.save_cpu_time" class="classattr">
                                        <input id="ASharedMemoryManager.save_cpu_time-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr variable">
            <span class="name">save_cpu_time</span><span class="annotation">: bool</span>

                <label class="view-source-button" for="ASharedMemoryManager.save_cpu_time-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#ASharedMemoryManager.save_cpu_time"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="ASharedMemoryManager.save_cpu_time-157"><a href="#ASharedMemoryManager.save_cpu_time-157"><span class="linenos">157</span></a>    <span class="nd">@property</span>
</span><span id="ASharedMemoryManager.save_cpu_time-158"><a href="#ASharedMemoryManager.save_cpu_time-158"><span class="linenos">158</span></a>    <span class="k">def</span> <span class="nf">save_cpu_time</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">bool</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.save_cpu_time-159"><a href="#ASharedMemoryManager.save_cpu_time-159"><span class="linenos">159</span></a>        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_save_cpu_time</span>
</span></pre></div>
                            ...
                            <div id="ASharedMemoryManager.time_limit" class="classattr">
                                <div class="attr variable">
            <span class="name">time_limit</span><span class="annotation">: Union[int, float, NoneType]</span>

        
    </div>
    <a class="headerlink" href="#ASharedMemoryManager.time_limit"></a>
    
    

                            </div>
                            <div id="ASharedMemoryManager.requests_from_clients" class="classattr">
                                <div class="attr variable">
            <span class="name">requests_from_clients</span><span class="annotation">: List[_asyncio.Future]</span>

        
    </div>
    <a class="headerlink" href="#ASharedMemoryManager.requests_from_clients"></a>
    
    

                            </div>
                            <div id="ASharedMemoryManager.clients_readyness" class="classattr">
                                <div class="attr variable">
            <span class="name">clients_readyness</span><span class="annotation">: List[_asyncio.Future]</span>

        
    </div>
    <a class="headerlink" href="#ASharedMemoryManager.clients_readyness"></a>
    
    

                            </div>
                            <div id="ASharedMemoryManager.closed" class="classattr">
                                <div class="attr variable">
            <span class="name">closed</span><span class="annotation">: bool</span>

        
    </div>
    <a class="headerlink" href="#ASharedMemoryManager.closed"></a>
    
    

                            </div>
                            <div id="ASharedMemoryManager.close_requested" class="classattr">
                                <div class="attr variable">
            <span class="name">close_requested</span><span class="annotation">: bool</span>

        
    </div>
    <a class="headerlink" href="#ASharedMemoryManager.close_requested"></a>
    
    

                            </div>
                            <div id="ASharedMemoryManager.close_requests" class="classattr">
                                <div class="attr variable">
            <span class="name">close_requests</span><span class="annotation">: List[_asyncio.Future]</span>

        
    </div>
    <a class="headerlink" href="#ASharedMemoryManager.close_requests"></a>
    
    

                            </div>
                            <div id="ASharedMemoryManager.has_messages_requests" class="classattr">
                                <div class="attr variable">
            <span class="name">has_messages_requests</span><span class="annotation">: List[_asyncio.Future]</span>

        
    </div>
    <a class="headerlink" href="#ASharedMemoryManager.has_messages_requests"></a>
    
    

                            </div>
                            <div id="ASharedMemoryManager.worker_task" class="classattr">
                                <div class="attr variable">
            <span class="name">worker_task</span><span class="annotation">: _asyncio.Task</span>

        
    </div>
    <a class="headerlink" href="#ASharedMemoryManager.worker_task"></a>
    
    

                            </div>
                            <div id="ASharedMemoryManager.aclose" class="classattr">
                                        <input id="ASharedMemoryManager.aclose-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
            
        <span class="def">async def</span>
        <span class="name">aclose</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">self</span></span><span class="return-annotation">) -> <span class="kc">None</span>:</span></span>

                <label class="view-source-button" for="ASharedMemoryManager.aclose-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#ASharedMemoryManager.aclose"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="ASharedMemoryManager.aclose-169"><a href="#ASharedMemoryManager.aclose-169"><span class="linenos">169</span></a>    <span class="k">async</span> <span class="k">def</span> <span class="nf">aclose</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.aclose-170"><a href="#ASharedMemoryManager.aclose-170"><span class="linenos">170</span></a>        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">closed</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.aclose-171"><a href="#ASharedMemoryManager.aclose-171"><span class="linenos">171</span></a>            <span class="k">return</span>
</span><span id="ASharedMemoryManager.aclose-172"><a href="#ASharedMemoryManager.aclose-172"><span class="linenos">172</span></a>        
</span><span id="ASharedMemoryManager.aclose-173"><a href="#ASharedMemoryManager.aclose-173"><span class="linenos">173</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">close_requested</span> <span class="o">=</span> <span class="kc">True</span>
</span><span id="ASharedMemoryManager.aclose-174"><a href="#ASharedMemoryManager.aclose-174"><span class="linenos">174</span></a>        <span class="n">close_request</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span><span class="o">.</span><span class="n">create_future</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.aclose-175"><a href="#ASharedMemoryManager.aclose-175"><span class="linenos">175</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">close_requests</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">close_request</span><span class="p">)</span>
</span><span id="ASharedMemoryManager.aclose-176"><a href="#ASharedMemoryManager.aclose-176"><span class="linenos">176</span></a>        <span class="k">await</span> <span class="n">close_request</span>
</span></pre></div>
                            ...
                            <div id="ASharedMemoryManager.close" class="classattr">
                                        <input id="ASharedMemoryManager.close-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
            
        <span class="def">def</span>
        <span class="name">close</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">self</span></span><span class="return-annotation">) -> <span class="n">Union</span><span class="p">[</span><span class="n">_asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">,</span> <span class="n">NoneType</span><span class="p">]</span>:</span></span>

                <label class="view-source-button" for="ASharedMemoryManager.close-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#ASharedMemoryManager.close"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="ASharedMemoryManager.close-178"><a href="#ASharedMemoryManager.close-178"><span class="linenos">178</span></a>    <span class="k">def</span> <span class="nf">close</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Optional</span><span class="p">[</span><span class="n">asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">]:</span>
</span><span id="ASharedMemoryManager.close-179"><a href="#ASharedMemoryManager.close-179"><span class="linenos">179</span></a>        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">closed</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.close-180"><a href="#ASharedMemoryManager.close-180"><span class="linenos">180</span></a>            <span class="k">return</span> <span class="kc">None</span>
</span><span id="ASharedMemoryManager.close-181"><a href="#ASharedMemoryManager.close-181"><span class="linenos">181</span></a>
</span><span id="ASharedMemoryManager.close-182"><a href="#ASharedMemoryManager.close-182"><span class="linenos">182</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">close_requested</span> <span class="o">=</span> <span class="kc">True</span>
</span><span id="ASharedMemoryManager.close-183"><a href="#ASharedMemoryManager.close-183"><span class="linenos">183</span></a>        <span class="n">close_request</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span><span class="o">.</span><span class="n">create_future</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.close-184"><a href="#ASharedMemoryManager.close-184"><span class="linenos">184</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">close_requests</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">close_request</span><span class="p">)</span>
</span><span id="ASharedMemoryManager.close-185"><a href="#ASharedMemoryManager.close-185"><span class="linenos">185</span></a>        <span class="k">return</span> <span class="n">close_request</span>
</span></pre></div>
                            ...
                            <div id="ASharedMemoryManager.run" class="classattr">
                                        <input id="ASharedMemoryManager.run-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
        ...
        <span class="name">run</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">self</span></span><span class="return-annotation">):</span></span>
                ...
                <label class="view-source-button" for="ASharedMemoryManager.run-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#ASharedMemoryManager.run"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="ASharedMemoryManager.run-187"><a href="#ASharedMemoryManager.run-187"><span class="linenos">187</span></a>    <span class="k">def</span> <span class="nf">run</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
</span><span id="ASharedMemoryManager.run-188"><a href="#ASharedMemoryManager.run-188"><span class="linenos">188</span></a>        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">worker_task</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.run-189"><a href="#ASharedMemoryManager.run-189"><span class="linenos">189</span></a>            <span class="k">return</span>
</span><span id="ASharedMemoryManager.run-190"><a href="#ASharedMemoryManager.run-190"><span class="linenos">190</span></a>        
</span><span id="ASharedMemoryManager.run-191"><a href="#ASharedMemoryManager.run-191"><span class="linenos">191</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span> <span class="o">=</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">get_event_loop</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.run-192"><a href="#ASharedMemoryManager.run-192"><span class="linenos">192</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">worker_task</span> <span class="o">=</span> <span class="n">create_task_awaitable</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">worker</span><span class="p">())</span>
</span></pre></div>
                            ...
                            <div id="ASharedMemoryManager.get_in_line" class="classattr">
                                        <input id="ASharedMemoryManager.get_in_line-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
            
        <span class="def">def</span>
        <span class="name">get_in_line</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">self</span></span><span class="return-annotation">) -> <span class="n">_asyncio</span><span class="o">.</span><span class="n">Future</span>:</span></span>

                <label class="view-source-button" for="ASharedMemoryManager.get_in_line-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#ASharedMemoryManager.get_in_line"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="ASharedMemoryManager.get_in_line-194"><a href="#ASharedMemoryManager.get_in_line-194"><span class="linenos">194</span></a>    <span class="k">def</span> <span class="nf">get_in_line</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">Future</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.get_in_line-195"><a href="#ASharedMemoryManager.get_in_line-195"><span class="linenos">195</span></a>        <span class="n">get_in_line_future</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span><span class="o">.</span><span class="n">create_future</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.get_in_line-196"><a href="#ASharedMemoryManager.get_in_line-196"><span class="linenos">196</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">requests_from_clients</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">get_in_line_future</span><span class="p">)</span>
</span><span id="ASharedMemoryManager.get_in_line-197"><a href="#ASharedMemoryManager.get_in_line-197"><span class="linenos">197</span></a>        <span class="k">return</span> <span class="n">get_in_line_future</span>
</span></pre></div>
                            ...
                            <div id="ASharedMemoryManager.has_messages" class="classattr">
                                        <input id="ASharedMemoryManager.has_messages-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
            
        <span class="def">async def</span>
        <span class="name">has_messages</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">self</span></span><span class="return-annotation">):</span></span>

                <label class="view-source-button" for="ASharedMemoryManager.has_messages-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#ASharedMemoryManager.has_messages"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="ASharedMemoryManager.has_messages-199"><a href="#ASharedMemoryManager.has_messages-199"><span class="linenos">199</span></a>    <span class="k">async</span> <span class="k">def</span> <span class="nf">has_messages</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
</span><span id="ASharedMemoryManager.has_messages-200"><a href="#ASharedMemoryManager.has_messages-200"><span class="linenos">200</span></a>        <span class="n">has_messages_future</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span><span class="o">.</span><span class="n">create_future</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.has_messages-201"><a href="#ASharedMemoryManager.has_messages-201"><span class="linenos">201</span></a>        <span class="bp">self</span><span class="o">.</span><span class="n">has_messages_requests</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">has_messages_future</span><span class="p">)</span>
</span><span id="ASharedMemoryManager.has_messages-202"><a href="#ASharedMemoryManager.has_messages-202"><span class="linenos">202</span></a>        <span class="k">return</span> <span class="k">await</span> <span class="n">has_messages_future</span>
</span></pre></div>
                            ...
                            <div id="ASharedMemoryManager.worker" class="classattr">
                                        <input id="ASharedMemoryManager.worker-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr function">
            
        <span class="def">async def</span>
        <span class="name">worker</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">self</span></span><span class="return-annotation">):</span></span>

                <label class="view-source-button" for="ASharedMemoryManager.worker-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#ASharedMemoryManager.worker"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="ASharedMemoryManager.worker-207"><a href="#ASharedMemoryManager.worker-207"><span class="linenos">207</span></a>    <span class="k">async</span> <span class="k">def</span> <span class="nf">worker</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
</span><span id="ASharedMemoryManager.worker-208"><a href="#ASharedMemoryManager.worker-208"><span class="linenos">208</span></a>        <span class="k">try</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-209"><a href="#ASharedMemoryManager.worker-209"><span class="linenos">209</span></a>            <span class="k">async</span> <span class="k">with</span> <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-210"><a href="#ASharedMemoryManager.worker-210"><span class="linenos">210</span></a>                <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">create</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-211"><a href="#ASharedMemoryManager.worker-211"><span class="linenos">211</span></a>                    <span class="k">await</span> <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">await_consumer_ready</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">time_limit</span><span class="p">)</span>
</span><span id="ASharedMemoryManager.worker-212"><a href="#ASharedMemoryManager.worker-212"><span class="linenos">212</span></a>                <span class="k">else</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-213"><a href="#ASharedMemoryManager.worker-213"><span class="linenos">213</span></a>                    <span class="k">await</span> <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">ainit_consumer</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">time_limit</span><span class="p">)</span>
</span><span id="ASharedMemoryManager.worker-214"><a href="#ASharedMemoryManager.worker-214"><span class="linenos">214</span></a>                
</span><span id="ASharedMemoryManager.worker-215"><a href="#ASharedMemoryManager.worker-215"><span class="linenos">215</span></a>                <span class="k">while</span> <span class="ow">not</span> <span class="bp">self</span><span class="o">.</span><span class="n">close_requested</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-216"><a href="#ASharedMemoryManager.worker-216"><span class="linenos">216</span></a>                    <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">requests_from_clients</span> <span class="ow">or</span> <span class="bp">self</span><span class="o">.</span><span class="n">has_messages_requests</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-217"><a href="#ASharedMemoryManager.worker-217"><span class="linenos">217</span></a>                        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">get_in_line</span><span class="p">():</span>
</span><span id="ASharedMemoryManager.worker-218"><a href="#ASharedMemoryManager.worker-218"><span class="linenos">218</span></a>                            <span class="k">try</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-219"><a href="#ASharedMemoryManager.worker-219"><span class="linenos">219</span></a>                                <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">has_messages</span><span class="p">():</span>
</span><span id="ASharedMemoryManager.worker-220"><a href="#ASharedMemoryManager.worker-220"><span class="linenos">220</span></a>                                    <span class="n">has_messages_requests_buff</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">has_messages_requests</span>
</span><span id="ASharedMemoryManager.worker-221"><a href="#ASharedMemoryManager.worker-221"><span class="linenos">221</span></a>                                    <span class="bp">self</span><span class="o">.</span><span class="n">has_messages_requests</span> <span class="o">=</span> <span class="nb">list</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.worker-222"><a href="#ASharedMemoryManager.worker-222"><span class="linenos">222</span></a>                                    <span class="k">for</span> <span class="n">has_messages_request</span> <span class="ow">in</span> <span class="n">has_messages_requests_buff</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-223"><a href="#ASharedMemoryManager.worker-223"><span class="linenos">223</span></a>                                        <span class="n">has_messages_request</span><span class="o">.</span><span class="n">set_result</span><span class="p">(</span><span class="kc">True</span><span class="p">)</span>
</span><span id="ASharedMemoryManager.worker-224"><a href="#ASharedMemoryManager.worker-224"><span class="linenos">224</span></a>                                
</span><span id="ASharedMemoryManager.worker-225"><a href="#ASharedMemoryManager.worker-225"><span class="linenos">225</span></a>                                <span class="n">requests_from_clients_buff</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">requests_from_clients</span>
</span><span id="ASharedMemoryManager.worker-226"><a href="#ASharedMemoryManager.worker-226"><span class="linenos">226</span></a>                                <span class="bp">self</span><span class="o">.</span><span class="n">requests_from_clients</span> <span class="o">=</span> <span class="nb">list</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.worker-227"><a href="#ASharedMemoryManager.worker-227"><span class="linenos">227</span></a>                                <span class="k">for</span> <span class="n">request_from_client</span> <span class="ow">in</span> <span class="n">requests_from_clients_buff</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-228"><a href="#ASharedMemoryManager.worker-228"><span class="linenos">228</span></a>                                    <span class="n">client_ready_future</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_loop</span><span class="o">.</span><span class="n">create_future</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.worker-229"><a href="#ASharedMemoryManager.worker-229"><span class="linenos">229</span></a>                                    <span class="n">request_from_client</span><span class="o">.</span><span class="n">set_result</span><span class="p">(</span><span class="n">client_ready_future</span><span class="p">)</span>
</span><span id="ASharedMemoryManager.worker-230"><a href="#ASharedMemoryManager.worker-230"><span class="linenos">230</span></a>                                    <span class="bp">self</span><span class="o">.</span><span class="n">clients_readyness</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">client_ready_future</span><span class="p">)</span>
</span><span id="ASharedMemoryManager.worker-231"><a href="#ASharedMemoryManager.worker-231"><span class="linenos">231</span></a>                                
</span><span id="ASharedMemoryManager.worker-232"><a href="#ASharedMemoryManager.worker-232"><span class="linenos">232</span></a>                                <span class="n">client_results</span> <span class="o">=</span> <span class="k">await</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">gather</span><span class="p">(</span><span class="o">*</span><span class="bp">self</span><span class="o">.</span><span class="n">clients_readyness</span><span class="p">,</span> <span class="n">return_exceptions</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
</span><span id="ASharedMemoryManager.worker-233"><a href="#ASharedMemoryManager.worker-233"><span class="linenos">233</span></a>                                <span class="bp">self</span><span class="o">.</span><span class="n">clients_readyness</span><span class="o">.</span><span class="n">clear</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.worker-234"><a href="#ASharedMemoryManager.worker-234"><span class="linenos">234</span></a>                            <span class="k">finally</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-235"><a href="#ASharedMemoryManager.worker-235"><span class="linenos">235</span></a>                                <span class="bp">self</span><span class="o">.</span><span class="n">shared_memory</span><span class="o">.</span><span class="n">release</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.worker-236"><a href="#ASharedMemoryManager.worker-236"><span class="linenos">236</span></a>                            
</span><span id="ASharedMemoryManager.worker-237"><a href="#ASharedMemoryManager.worker-237"><span class="linenos">237</span></a>                            <span class="k">if</span> <span class="nb">any</span><span class="p">(</span><span class="n">client_results</span><span class="p">):</span>
</span><span id="ASharedMemoryManager.worker-238"><a href="#ASharedMemoryManager.worker-238"><span class="linenos">238</span></a>                                <span class="k">await</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">sleep</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span>
</span><span id="ASharedMemoryManager.worker-239"><a href="#ASharedMemoryManager.worker-239"><span class="linenos">239</span></a>                            <span class="k">else</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-240"><a href="#ASharedMemoryManager.worker-240"><span class="linenos">240</span></a>                                <span class="k">await</span> <span class="n">asyncio</span><span class="o">.</span><span class="n">sleep</span><span class="p">(</span><span class="n">get_usable_min_sleep_interval</span><span class="p">())</span>
</span><span id="ASharedMemoryManager.worker-241"><a href="#ASharedMemoryManager.worker-241"><span class="linenos">241</span></a>                    <span class="k">else</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-242"><a href="#ASharedMemoryManager.worker-242"><span class="linenos">242</span></a>                        <span class="k">await</span> <span class="bp">self</span><span class="o">.</span><span class="n">_asleep_func</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.worker-243"><a href="#ASharedMemoryManager.worker-243"><span class="linenos">243</span></a>        <span class="k">finally</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-244"><a href="#ASharedMemoryManager.worker-244"><span class="linenos">244</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">closed</span> <span class="o">=</span> <span class="kc">True</span>
</span><span id="ASharedMemoryManager.worker-245"><a href="#ASharedMemoryManager.worker-245"><span class="linenos">245</span></a>            <span class="k">for</span> <span class="n">close_request</span> <span class="ow">in</span> <span class="bp">self</span><span class="o">.</span><span class="n">close_requests</span><span class="p">:</span>
</span><span id="ASharedMemoryManager.worker-246"><a href="#ASharedMemoryManager.worker-246"><span class="linenos">246</span></a>                <span class="n">close_request</span><span class="o">.</span><span class="n">set_result</span><span class="p">(</span><span class="kc">None</span><span class="p">)</span>
</span><span id="ASharedMemoryManager.worker-247"><a href="#ASharedMemoryManager.worker-247"><span class="linenos">247</span></a>            
</span><span id="ASharedMemoryManager.worker-248"><a href="#ASharedMemoryManager.worker-248"><span class="linenos">248</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">close_requests</span><span class="o">.</span><span class="n">clear</span><span class="p">()</span>
</span><span id="ASharedMemoryManager.worker-249"><a href="#ASharedMemoryManager.worker-249"><span class="linenos">249</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">close_requested</span> <span class="o">=</span> <span class="kc">False</span>
</span><span id="ASharedMemoryManager.worker-250"><a href="#ASharedMemoryManager.worker-250"><span class="linenos">250</span></a>            <span class="bp">self</span><span class="o">.</span><span class="n">worker_task</span> <span class="o">=</span> <span class="kc">None</span>
</span></pre></div>
                ...
                <section id="ASMM">
                    <div class="attr variable">
            <span class="name">ASMM</span>        =
<input id="ASMM-view-value" class="view-value-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
            <label class="view-value-button pdoc-button" for="ASMM-view-value"></label><span class="default_value">&lt;class &#39;<a href="#ASharedMemoryManager">ASharedMemoryManager</a>&#39;&gt;</span>

        
    </div>
    <a class="headerlink" href="#ASMM"></a>
