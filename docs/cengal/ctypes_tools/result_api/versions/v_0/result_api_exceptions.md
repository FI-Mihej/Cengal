...
<div>
    <main class="pdoc">
            <section class="module-info">
                    <h1 class="modulename">
cengal<wbr>.ctypes_tools<wbr>.result_api<wbr>.versions<wbr>.v_0<wbr>.result_api_exceptions    </h1>

                
                        <input id="mod-result_api_exceptions-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">

                        <label class="view-source-button" for="mod-result_api_exceptions-view-source"><span>View Source</span></label>
...
</span><span id="L-19"><a href="#L-19"><span class="linenos">19</span></a><span class="n">__all__</span> <span class="o">=</span> <span class="p">[</span><span class="s1">&#39;CtypesToolsResultAPIError&#39;</span><span class="p">]</span>
...
</span><span id="L-40"><a href="#L-40"><span class="linenos">40</span></a><span class="k">class</span> <span class="nc">CtypesToolsResultAPIError</span><span class="p">(</span><span class="ne">Exception</span><span class="p">):</span>
</span><span id="L-41"><a href="#L-41"><span class="linenos">41</span></a>    <span class="k">pass</span>
</span></pre></div>


            </section>
                <section id="CtypesToolsResultAPIError">
                            <input id="CtypesToolsResultAPIError-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr class">
            
    <span class="def">class</span>
    <span class="name">CtypesToolsResultAPIError</span><wbr>(<span class="base">builtins.Exception</span>):

                <label class="view-source-button" for="CtypesToolsResultAPIError-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#CtypesToolsResultAPIError"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="CtypesToolsResultAPIError-41"><a href="#CtypesToolsResultAPIError-41"><span class="linenos">41</span></a><span class="k">class</span> <span class="nc">CtypesToolsResultAPIError</span><span class="p">(</span><span class="ne">Exception</span><span class="p">):</span>
</span><span id="CtypesToolsResultAPIError-42"><a href="#CtypesToolsResultAPIError-42"><span class="linenos">42</span></a>    <span class="k">pass</span>
</span></pre></div>
            ...
            <div class="docstring"><p>Common base class for all non-exit exceptions.</p>
                            ...
                            <div class="inherited">
                                ...
                                <dd id="CtypesToolsResultAPIError.__init__" class="function">Exception</dd>

            </div>
            <div><dt>builtins.BaseException</dt>
                                <dd id="CtypesToolsResultAPIError.with_traceback" class="function">with_traceback</dd>
                <dd id="CtypesToolsResultAPIError.args" class="variable">args</dd>
