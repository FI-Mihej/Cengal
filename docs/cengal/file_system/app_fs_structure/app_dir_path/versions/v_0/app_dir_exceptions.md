...
<div>
    <main class="pdoc">
            <section class="module-info">
                    <h1 class="modulename">
cengal<wbr>.file_system<wbr>.app_fs_structure<wbr>.app_dir_path<wbr>.versions<wbr>.v_0<wbr>.app_dir_exceptions    </h1>

                
                        <input id="mod-app_dir_exceptions-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">

                        <label class="view-source-button" for="mod-app_dir_exceptions-view-source"><span>View Source</span></label>
...
</span><span id="L-19"><a href="#L-19"><span class="linenos">19</span></a><span class="n">__all__</span> <span class="o">=</span> <span class="p">[</span><span class="s1">&#39;NotAwailableAppDirError&#39;</span><span class="p">]</span>
...
</span><span id="L-39"><a href="#L-39"><span class="linenos">39</span></a><span class="k">class</span> <span class="nc">NotAwailableAppDirError</span><span class="p">(</span><span class="ne">Exception</span><span class="p">):</span>
</span><span id="L-40"><a href="#L-40"><span class="linenos">40</span></a>    <span class="k">pass</span>
</span></pre></div>


            </section>
                <section id="NotAwailableAppDirError">
                            <input id="NotAwailableAppDirError-view-source" class="view-source-toggle-state" type="checkbox" aria-hidden="true" tabindex="-1">
<div class="attr class">
            
    <span class="def">class</span>
    <span class="name">NotAwailableAppDirError</span><wbr>(<span class="base">builtins.Exception</span>):

                <label class="view-source-button" for="NotAwailableAppDirError-view-source"><span>View Source</span></label>

    </div>
    <a class="headerlink" href="#NotAwailableAppDirError"></a>
            <div class="pdoc-code codehilite"><pre><span></span><span id="NotAwailableAppDirError-40"><a href="#NotAwailableAppDirError-40"><span class="linenos">40</span></a><span class="k">class</span> <span class="nc">NotAwailableAppDirError</span><span class="p">(</span><span class="ne">Exception</span><span class="p">):</span>
</span><span id="NotAwailableAppDirError-41"><a href="#NotAwailableAppDirError-41"><span class="linenos">41</span></a>    <span class="k">pass</span>
</span></pre></div>
            ...
            <div class="docstring"><p>Common base class for all non-exit exceptions.</p>
                            ...
                            <div class="inherited">
                                ...
                                <dd id="NotAwailableAppDirError.__init__" class="function">Exception</dd>

            </div>
            <div><dt>builtins.BaseException</dt>
                                <dd id="NotAwailableAppDirError.with_traceback" class="function">with_traceback</dd>
                <dd id="NotAwailableAppDirError.args" class="variable">args</dd>
