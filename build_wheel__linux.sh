...
IMAGES=("manylinux2014_x86_64" "musllinux_1_1_x86_64")

declare -A DOCKER_IMAGES
DOCKER_IMAGES["manylinux2014_x86_64"]="cp310-cp310 cp311-cp311 cp312-cp312 cp36-cp36m cp37-cp37m cp38-cp38 cp39-cp39 pp310-pypy310_pp73 pp37-pypy37_pp73 pp38-pypy38_pp73 pp39-pypy39_pp73"
DOCKER_IMAGES["musllinux_1_1_x86_64"]="cp310-cp310 cp311-cp311 cp312-cp312 cp36-cp36m cp37-cp37m cp38-cp38 cp39-cp39"
...
for IMAGE_NAME in "${IMAGES[@]}"; do
    ...
    for PYTHON_VER in $PYTHON_VERSIONS; do
        ...
        docker run -i -v `pwd`:/io quay.io/pypa/$IMAGE_NAME /bin/bash -c "
            ...
            export PYTHONPATH=/io:\$PYTHONPATH;
            /opt/python/$PYTHON_VER/bin/python /io/cengal_setup_scripts/install_required_packages/install_packages.py;
